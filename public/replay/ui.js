/*! 'ui.js is part of ReplayWeb.page (https://replayweb.page) Copyright (C) 2020-2023, Webrecorder Software. Licensed under the Affero General Public License v3.' */ (() => {
  var __webpack_modules__ = {
        ...
        var i =
          ...
          a =
            ...
            function (e, t, a) {
                ...
                o[e] &&
                  (r[e] = function (t) {
                    return new Promise(function (i, a) {
                      n.push([e, t, i, a]) > 1 || l(e, t);
                    });
                  });
              }
              function l(e, t) {
                try {
                  (a = o[e](t)).value instanceof i
                    ? Promise.resolve(a.value.v).then(c, d)
                    : h(n[0][2], a);
                } catch (e) {
                  h(n[0][3], e);
                }
              ...
              function h(e, t) {
                e(t), n.shift(), n.length && l(n[0][0], n[0][1]);
              }
            };
          ...
          (t.default = function (e) {
            return a(this, arguments, function* () {
              ...
              let r = "",
                o = e.read();
              for (;;) {
                const { done: n, value: s } = yield i(o);
                if (n)
                  return (
                    r.length > 0 && (yield yield i(JSON.parse(r))),
                    yield i(void 0)
                  );
                r += a.decode(s, { stream: !0 });
                const l = r.split(t);
                r = l.pop();
                for (const e of l) yield yield i(JSON.parse(e));
                o = e.read();
              }
            });
          });
        ...
        (module = __webpack_require__.nmd(module)),
          ...
          (function _f(self) {
            ...
            function ha(e) {
              let t = "",
                i = "";
              for (let a, r = 0, o = e.length; r < o; r++)
                (a = e[r]) !== i && (t += i = a);
              return t;
            }
            ...
            function ma(e, t, i, a) {
              ...
              for (let c = r - 1; 0 <= c; c--) {
                ...
                for (let e = 0; e < h; e++) {
                  const h = d[e],
                    u = h.length;
                  if (u)
                    for (let e, d, p = 0; p < u; p++)
                      if (((d = h[p]), o)) {
                        if (o[d]) {
                          if (!c)
                            if (i) i--;
                            else if (((s[l++] = d), l === t)) return s;
                          (c || a) && (f[d] = 1), (b = !0);
                        }
                        if (a && ((n[d] = (e = n[d]) ? ++e : (e = 1)), e < r)) {
                          const t = a[e - 2] || (a[e - 2] = []);
                          t[t.length] = d;
                        }
                      } else f[d] = 1;
              ...
              if (a)
                for (let e, r, n = a.length - 1; 0 <= n; n--) {
                  (e = a[n]), (r = e.length);
                  for (let a, n = 0; n < r; n++)
                    if (((a = e[n]), !o[a])) {
                      if (i) i--;
                      else if (((s[l++] = a), l === t)) return s;
                      o[a] = 1;
                    }
                }
              return s;
            ...
            function na(e, t) {
              ...
              for (let e, o = 0; o < t.length; o++) {
                ...
                for (let t, o = 0; o < e.length; o++)
                  (t = e[o]), i[t] && !a[t] && ((a[t] = 1), (r[r.length] = t));
              }
              return r;
            }
            function J(e) {
            ...
            function oa(e, t, i) {
              ...
              return a || ((a = this.search(e, t, i)), this.cache.set(e, a)), a;
            }
            ...
            function ra(e, t, i, a, r, o) {
              setTimeout(function () {
                const n = e(i, JSON.stringify(o));
                n && n.then
                  ? n.then(function () {
                      t.export(e, t, i, a, r + 1);
                    })
                  : t.export(e, t, i, a, r + 1);
              });
            }
            function K(e, t) {
              ...
              if (e) {
                x(e)
                  ? (e = qa[e])
                  : (i = e.preset) && (e = Object.assign({}, i[i], e)),
                  (i = e.charset);
                var a = e.lang;
                x(i) &&
                  (-1 === i.indexOf(":") && (i += ":default"), (i = G[i])),
                  x(a) && (a = ka[a]);
              } else e = {};
              let r,
                o,
                n = e.context || {};
              if (
                ((this.encode = e.encode || (i && i.encode) || ia),
                (this.register = t || v()),
                (this.D = r = e.resolution || 9),
                (this.G = t = (i && i.G) || e.tokenize || "strict"),
                (this.depth = "strict" === t && n.depth),
                (this.l = u(n.bidirectional)),
                (this.s = o = u(e.optimize)),
                (this.m = u(e.fastupdate)),
                (this.B = e.minlength || 1),
                (this.C = e.boost),
                (this.map = o ? aa(r) : v()),
                (this.A = r = n.resolution || 1),
                (this.h = o ? aa(r) : v()),
                (this.F = (i && i.F) || e.rtl),
                (this.H = (t = e.matcher || (a && a.H)) && fa(t, !1)),
                (this.J = (t = e.stemmer || (a && a.J)) && fa(t, !0)),
                (i = t = e.filter || (a && a.filter)))
              ) {
                (i = t), (a = v());
                for (let e = 0, t = i.length; e < t; e++) a[i[e]] = 1;
                i = a;
              }
              (this.filter = i), (this.cache = (t = e.cache) && new J(t));
            }
            ...
            function M(e, t, i, a, r, o, n) {
              ...
              (!t[i] || (n && !t[i][n])) &&
                ...
                (o && -1 !== s.indexOf(r)) ||
                  ((s[s.length] = r),
                  e.m &&
                    ((e = e.register[r] || (e.register[r] = []))[e.length] =
                      s)));
            }
            function sa(e, t, i, a, r, o, n, s) {
              let l = [],
                c = s ? e.h : e.map;
              if ((e.s || (c = ua(c, n, s, e.l)), c)) {
                let i = 0;
                const d = Math.min(c.length, s ? e.A : e.D);
                for (
                  let t, h, f = 0, b = 0;
                  f < d &&
                  !(
                    ...
                    r &&
                      ...
                      h <= r
                        ? ((r -= h), (t = null))
                        : ((t = t.slice(r)), (r = 0))),
                    t && ((l[i++] = t), o && ((b += t.length), b >= a)))
                  );
                  f++
                );
                if (i) return o ? ta(l, a, 0) : void (t[t.length] = l);
              }
              return !i && l;
            }
            function ta(e, t, i) {
              return (
                ...
                i || e.length > t ? e.slice(i, i + t) : e
              );
            }
            function ua(e, t, i, a) {
              return (
                i
                  ? (e = (e = e[(a = a && t > i) ? t : i]) && e[a ? i : t])
                  : (e = e[t]),
                e
              );
            }
            function N(e, t, i, a, r) {
              ...
              if (e.constructor === Array)
                if (r)
                  -1 !== (t = e.indexOf(t))
                    ? 1 < e.length && (e.splice(t, 1), o++)
                    : o++;
                else {
                  r = Math.min(e.length, i);
                  for (let n, s = 0; s < r; s++)
                    (n = e[s]) &&
                      ((o = N(n, t, i, a, r)), a || o || delete e[s]);
                }
              else for (let n in e) (o = N(e[n], t, i, a, r)) || delete e[n];
              return o;
            }
            function va(e) {
              e = e.data;
              ...
              if ("init" === a)
                (a = e.options || {}),
                  ...
                  t &&
                    ...
                    (a.encode = Function("return " + t)()),
                  e
                    ? (Function("return " + e)()(self),
                      (self._index = new self.FlexSearch.Index(a)),
                      delete self.FlexSearch)
                    : (self._index = new K(a));
              else
                (e = e.id),
                  (t = t[a].apply(t, i)),
                  postMessage("search" === a ? { id: e, msg: t } : { id: e });
            }
            (t = K.prototype),
              (t.append = function (e, t) {
                return this.add(e, t, !0);
              }),
              (t.add = function (e, t, i, a) {
                if (t && (e || 0 === e)) {
                  if (!a && !i && this.register[e]) return this.update(e, t);
                  if ((a = (t = this.encode(t)).length)) {
                    const c = v(),
                      d = v(),
                      h = this.depth,
                      f = this.D;
                    for (let b = 0; b < a; b++) {
                      let u = t[this.F ? a - 1 - b : b];
                      var r = u.length;
                      if (u && r >= this.B && (h || !d[u])) {
                        var o = L(f, a, b),
                          n = "";
                        switch (this.G) {
                          ...
                          case "reverse":
                            if (2 < r) {
                              for (s = r - 1; 0 < s; s--)
                                (n = u[s] + n).length >= this.B &&
                                  M(this, d, n, L(f, a, b, r, s), e, i);
                              n = "";
                            }
                          case "forward":
                            if (1 < r) {
              ...
              (t.search = function (e, t, i) {
                i || (!t && C(e) ? (e = (i = e).query) : C(t) && (i = t));
                let a,
                  r,
                  o,
                  n,
                  ...
                  c = 0;
                if (i) {
                  (t = i.limit), (c = i.offset || 0);
                  var d = i.context;
                  r = i.suggest;
                }
                if (e && ((a = (e = this.encode(e)).length), 1 < a)) {
                  i = v();
                  var h = [];
                  for (let t, o = 0, n = 0; o < a; o++)
                    if ((t = e[o]) && t.length >= this.B && !i[t]) {
                      if (!(this.s || r || this.map[t])) return l;
                      (h[n++] = t), (i[t] = 1);
                    }
                  a = (e = h).length;
                }
                ...
                for (
                  ...
                  if (
                    ((s = e[i]),
                    d
                      ? ((n = sa(this, l, r, t, c, 2 === a, s, o)),
                        (r && !1 === n && l.length) || (o = s))
                      : (n = sa(this, l, r, t, c, 1 === a, s)),
                    n)
                  )
                    return n;
                  if (r && i === a - 1) {
              ...
              (t.remove = function (e, t) {
                ...
                if (i) {
                  if (this.m)
                    for (let t, a = 0; a < i.length; a++)
                      (t = i[a]), t.splice(t.indexOf(e), 1);
                  else
                    N(this.map, e, this.D, this.s),
                      this.depth && N(this.h, e, this.A, this.s);
                  if ((t || delete this.register[e], this.cache)) {
                    t = this.cache;
                    for (let i, a, r = 0; r < t.h.length; r++)
                      (a = t.h[r]),
                        (i = t.cache[a]),
                        -1 !== i.indexOf(e) &&
                          (t.h.splice(r--, 1), delete t.cache[a]);
                  }
                }
                return this;
              }),
              (t.searchCache = oa),
              (t.export = function (e, t, i, a, r) {
                let o, n;
                switch (r || (r = 0)) {
                  case 0:
                    if (((o = "reg"), this.m)) {
                      n = v();
                      for (let e in this.register) n[e] = 1;
                    } else n = this.register;
                    break;
                  case 1:
                    (o = "cfg"), (n = { doc: 0, opt: this.s ? 1 : 0 });
                    break;
                  case 2:
                    (o = "map"), (n = this.map);
                    break;
                ...
                return ra(e, t || this, i ? i + "." + o : o, a, r, n), !0;
              }),
              (t.import = function (e, t) {
                if (t)
                  switch ((x(t) && (t = JSON.parse(t)), e)) {
                    case "cfg":
                      this.s = !!t.opt;
                      break;
                    case "reg":
            ...
            function O(e) {
              ...
              const i = self.exports,
                a = this;
              (this.o = xa(t, i, e.worker)),
                (this.h = v()),
                this.o &&
                  (i
            ...
            function P(e) {
              O.prototype[e] = O.prototype[e + "Async"] = function () {
                ...
                let r;
                return (
                  D(a) && ((r = a), i.splice(i.length - 1, 1)),
                  (a = new Promise(function (a) {
                    setTimeout(function () {
                      (t.h[++wa] = a),
                        t.o.postMessage({ task: e, id: wa, args: i });
                    });
                  })),
                  r ? (a.then(r), this) : a
                );
            ...
            function Q(e) {
              ...
              var t,
                i = e.document || e.doc || e;
              (this.K = []),
                (this.h = []),
                (this.A = []),
                (this.register = v()),
                (this.key = ((t = i.key || i.id) && S(t, this.A)) || "id"),
                (this.m = u(e.fastupdate)),
                (this.C = (t = i.store) && !0 !== t && []),
                (this.store = t && v()),
                (this.I = (t = i.tag) && S(t, this.A)),
                (this.l = t && v()),
                ...
                (this.async = !1),
                (t = v());
              let a = i.index || i.field || i;
              x(a) && (a = [a]);
              for (let i, r, o = 0; o < a.length; o++)
                (i = a[o]),
                  x(i) || ((r = i), (i = i.field)),
                  (r = C(r) ? Object.assign({}, e, r) : e),
                  this.o && ((t[i] = new O(r)), t[i].o || (this.o = !1)),
                  this.o || (t[i] = new K(r, this.register)),
                  (this.K[o] = S(i, this.A)),
                  (this.h[o] = i);
              if (this.C)
                for (x((e = i.store)) && (e = [e]), i = 0; i < e.length; i++)
            ...
            function S(e, t) {
              ...
              for (let r = 0; r < i.length; r++)
                0 <= (e = i[r]).indexOf("[]") &&
                  ...
                  (t[a] = !0),
                  e && (i[a++] = e);
              return a < i.length && (i.length = a), 1 < a ? i : i[0];
            }
            function T(e, t) {
              if (x(t)) e = e[t];
              else for (let i = 0; e && i < t.length; i++) e = e[t[i]];
              return e;
            }
            function U(e, t, i, a, r) {
              if (((e = e[r]), a === i.length - 1)) t[r] = e;
              else if (e)
                if (e.constructor === Array)
                  for (t = t[r] = Array(e.length), r = 0; r < e.length; r++)
                    U(e, t, i, a, r);
                else (t = t[r] || (t[r] = v())), (r = i[++a]), U(e, t, i, a, r);
            }
            function V(e, t, i, a, r, o, n, s) {
              if ((e = e[n]))
                if (a === t.length - 1) {
                  if (e.constructor === Array) {
                    if (i[a]) {
                      for (t = 0; t < e.length; t++) r.add(o, e[t], !0, !0);
                      return;
                    }
                    e = e.join(" ");
                  }
                  ...
                  for (n = 0; n < e.length; n++) V(e, t, i, a, r, o, n, s);
                else (n = t[++a]), V(e, t, i, a, r, o, n, s);
            }
            function ya(e, t, i, a) {
              let r = this.l[e],
                o = r && r.length - i;
            ...
            function za(e) {
              ...
              for (let i, a = 0; a < e.length; a++)
                (i = e[a]), (t[a] = { id: i, doc: this.store[i] });
              return t;
            }
            P("add"),
              P("append"),
              ...
              (t.add = function (e, t, i) {
                if ((C(e) && (e = T((t = e), this.key)), t && (e || 0 === e))) {
                  if (!i && this.register[e]) return this.update(e, t);
                  for (let a, r, o = 0; o < this.h.length; o++)
                    (r = this.h[o]),
                      (a = this.K[o]),
                      x(a) && (a = [a]),
                      V(t, a, this.A, 0, this.index[r], e, a[0], i);
                  if (this.I) {
                    let a = T(t, this.I),
                      r = v();
                    x(a) && (a = [a]);
                    for (let t, o, n = 0; n < a.length; n++)
                      if (
                        ((t = a[n]),
                        !r[t] &&
                          ((r[t] = 1),
                  ...
                  if (this.store && (!i || !this.store[e])) {
                    ...
                    if (this.C) {
                      i = v();
                      for (let e, a = 0; a < this.C.length; a++)
                        (e = this.C[a]),
                          x(e) ? (i[e] = t[e]) : U(t, i, e, 0, e[0]);
                    }
                    this.store[e] = i || t;
                  }
                }
              ...
              (t.remove = function (e) {
                if ((C(e) && (e = T(e, this.key)), this.register[e])) {
                  ...
                  if (this.I && !this.m)
                    for (let i in this.l) {
                      const a = (t = this.l[i]).indexOf(e);
                      -1 !== a &&
                        (1 < t.length ? t.splice(a, 1) : delete this.l[i]);
                    }
                  this.store && delete this.store[e], delete this.register[e];
                }
                return this;
              }),
              (t.search = function (e, t, i, a) {
                i ||
                  (!t && C(e)
                    ? (e = (i = e).query)
                    : C(t) && ((i = t), (t = 0)));
                let r,
                  ...
                  f = 0;
                if (i)
                  if (i.constructor === Array) (n = i), (i = null);
                  else {
                    if (
                      ((n = (r = i.pluck) || i.index || i.field),
                      (s = i.tag),
                      (o = this.store && i.enrich),
                      (l = "and" === i.bool),
                      (t = i.limit || 100),
                      (c = i.offset || 0),
                      s && (x(s) && (s = [s]), !e))
                ...
                n || (n = this.h),
                  (l = l && (1 < n.length || (s && 1 < s.length)));
                const b = !a && (this.o || this.async) && [];
                for (let r, o, u, p = 0; p < n.length; p++) {
                  let m;
                  if (((o = n[p]), x(o) || ((m = o), (o = o.field)), b))
                    b[p] = this.index[o].searchAsync(e, t, m || i);
                  else {
                    if (
                      ((r = a ? a[p] : this.index[o].search(e, t, m || i)),
                      (u = r && r.length),
                      s && u)
                    ) {
                      const e = [];
                      let i = 0;
                      l && (e[0] = [r]);
                      for (let t, a, r = 0; r < s.length; r++)
                        (t = s[r]),
                          (u = (a = this.l[t]) && a.length) &&
                            (i++, (e[e.length] = l ? [a] : a));
                      i &&
                        ((r = l ? ma(e, t || 100, c || 0) : na(r, e)),
                        (u = r.length));
                    }
                    if (u) (h[f] = o), (d[f++] = r);
                    else if (l) return [];
                ...
                if (!f) return [];
                if (r && (!o || !this.store)) return d[0];
                for (let e, t = 0; t < h.length; t++) {
                  if (((e = d[t]), e.length && o && (e = za.call(this, e)), r))
                    return e;
                  d[t] = { field: h[t], result: e };
                }
                return d;
              }),
              (t.contain = function (e) {
              ...
              (t.searchCache = oa),
              (t.export = function (e, t, i, a, r) {
                if ((r || (r = 0), a || (a = 0), a < this.h.length)) {
                  const i = this.h[a],
                    o = this.index[i];
                  (t = this),
                    setTimeout(function () {
                      o.export(e, t, r ? i.replace(":", "-") : "", a, r++) ||
                        (a++, (r = 1), t.export(e, t, i, a, r));
                    });
                } else {
                  let t;
                  switch (r) {
              ...
              (t.import = function (e, t) {
                if (t)
                  switch ((x(t) && (t = JSON.parse(t)), e)) {
                    ...
                    default:
                      const i = (e = e.split("."))[0];
                      (e = e[1]), i && e && this.index[i].import(e, t);
                  }
              }),
              la(Q.prototype);
            ...
            function Aa(e) {
              var t = e;
              return (
                t.normalize && (t = t.normalize("NFD").replace(ea, "")),
            ...
            function Da(e) {
              ...
              if ((e = Aa.call(this, e).join(" "))) {
                const i = e.split(Fa),
                  a = i.length;
                for (let r, o = 0, n = 0; o < a; o++)
                  if ((e = i[o]) && (!this.filter || !this.filter[e])) {
                    r = e[0];
                    let i = Ga[r] || r,
                      a = i;
            ...
            function Ha(e, t) {
              return (
                e &&
                  (2 < (e = Da.call(this, e).join(" ")).length &&
                    (e = E(e, Ja)),
                  t || (1 < e.length && (e = ha(e)), e && (e = e.split(" ")))),
                e
              );
            }
      ...
      8600: (e) => {
        ...
        const t = ["B", "kB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"],
          i = ["B", "kiB", "MiB", "GiB", "TiB", "PiB", "EiB", "ZiB", "YiB"],
          a = [
            "b",
            "kbit",
            "Mbit",
          ...
          o = (e, t, i) => {
            ...
            return (
              "string" == typeof t || Array.isArray(t)
                ? (a = e.toLocaleString(t, i))
                : (!0 !== t && void 0 === i) ||
                  (a = e.toLocaleString(void 0, i)),
              a
            );
          };
        e.exports = (e, n) => {
          ...
          const s = (n = Object.assign({ bits: !1, binary: !1 }, n)).bits
            ? n.binary
              ? r
              : a
            : n.binary
          ...
          if (
            ...
            void 0 !== n.maximumFractionDigits &&
              (d = Object.assign(
            ...
            return c + o(e, n.locale, d) + " " + s[0];
          }
          const h = Math.min(
            Math.floor(
              n.binary ? Math.log(e) / Math.log(1024) : Math.log10(e) / 3
            ),
            s.length - 1
          );
          (e /= Math.pow(n.binary ? 1024 : 1e3, h)),
            d || (e = e.toPrecision(3));
          return c + o(Number(e), n.locale, d) + " " + s[h];
        };
      },
      7529: (e) => {
        e.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-chevron-double-down" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 6.646a.5.5 0 0 1 .708 0L8 12.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"></path><path fill-rule="evenodd" d="M1.646 2.646a.5.5 0 0 1 .708 0L8 8.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"></path></svg>';
      },
      6873: (e) => {
        e.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-chevron-double-up" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M7.646 2.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 3.707 2.354 9.354a.5.5 0 1 1-.708-.708l6-6z"></path><path fill-rule="evenodd" d="M7.646 6.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 7.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z"></path></svg>';
      },
      1795: (e) => {
        e.exports =
      ...
      4199: (e) => {
        e.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M339 314.9L175.4 32h161.2l163.6 282.9H339zm-137.5 23.6L120.9 480h310.5L512 338.5H201.5zM154.1 67.4L0 338.5 80.6 480 237 208.8 154.1 67.4z"></path></svg>';
      },
      1734: (e) => {
        e.exports =
      ...
      6442: (e) => {
        e.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M143 352.3L7 216.3c-9.4-9.4-9.4-24.6 0-33.9l22.6-22.6c9.4-9.4 24.6-9.4 33.9 0l96.4 96.4 96.4-96.4c9.4-9.4 24.6-9.4 33.9 0l22.6 22.6c9.4 9.4 9.4 24.6 0 33.9l-136 136c-9.2 9.4-24.4 9.4-33.8 0z"></path></svg>';
      },
      426: (e) => {
        e.exports =
      ...
      9125: (e) => {
        e.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M528 0H48C21.5 0 0 21.5 0 48v320c0 26.5 21.5 48 48 48h192l-16 48h-72c-13.3 0-24 10.7-24 24s10.7 24 24 24h272c13.3 0 24-10.7 24-24s-10.7-24-24-24h-72l-16-48h192c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48zm-16 352H64V64h448v288z"></path></svg>';
      },
      5732: (e) => {
        e.exports =
      ...
      2164: (e) => {
        e.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512"><path d="M96 184c39.8 0 72 32.2 72 72s-32.2 72-72 72-72-32.2-72-72 32.2-72 72-72zM24 80c0 39.8 32.2 72 72 72s72-32.2 72-72S135.8 8 96 8 24 40.2 24 80zm0 352c0 39.8 32.2 72 72 72s72-32.2 72-72-32.2-72-72-72-72 32.2-72 72z"></path></svg>';
      },
      1615: (e) => {
        e.exports =
  ...
  (() => {
    ...
    const r = (e) => new a("string" == typeof e ? e : e + "", t),
      o = (e, ...i) => {
        const r =
          1 === e.length
            ? e[0]
    ...
    class u extends HTMLElement {
      ...
      static getPropertyDescriptor(e, t, i) {
        return {
          ...
          set(a) {
            const r = this[e];
            (this[t] = a), this.requestUpdate(e, r, i);
          },
          configurable: !0,
          enumerable: !0,
        };
      ...
      addController(e) {
        var t, i;
        (null !== (t = this._$Eg) && void 0 !== t ? t : (this._$Eg = [])).push(
          e
        ),
          ...
          (((i = i || this.constructor.getPropertyOptions(e)).hasChanged || f)(
            ...
            ? (this._$AL.has(e) || this._$AL.set(e, t),
              !0 === i.reflect &&
                ...
                this._$E_.set(e, i)))
            : (a = !1)),
          !this.isUpdatePending && a && (this._$Ep = this._$EC());
      }
      async _$EC() {
    ...
    const m = globalThis.trustedTypes,
      g = m ? m.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
      v = `lit$${(Math.random() + "").slice(9)}$`,
      w = "?" + v,
      x = `<${w}>`,
      k = document,
      y = (e = "") => k.createComment(e),
      ...
      P = T(1),
      U = (T(2), Symbol.for("lit-noChange")),
      R = Symbol.for("lit-nothing"),
      q = new WeakMap(),
      M = k.createTreeWalker(k, 129, null, !1),
      j = (e, t) => {
        const i = e.length - 1,
          a = [];
        let r,
        ...
        for (let t = 0; t < i; t++) {
          ...
          for (
            ;
            d < i.length && ((n.lastIndex = d), (l = n.exec(i)), null !== l);
              ...
              n === z
                ...
                ? ">" === l[0]
                  ...
                  : ((c = n.lastIndex - l[2].length),
                    (s = l[1]),
                    (n = void 0 === l[3] ? D : '"' === l[3] ? I : E))
                : n === I || n === E
                ? (n = D)
                : n === C || n === A
                ? (n = z)
                : ((n = D), (r = void 0));
          const h = n === D && e[t + 1].startsWith("/>") ? " " : "";
          o +=
            n === z
              ? i + x
              : c >= 0
              ? (a.push(s), i.slice(0, c) + "$lit$" + i.slice(c) + v + h)
              : i + v + (-2 === c ? (a.push(void 0), t) : h);
        }
        const s = o + (e[i] || "<?>") + (2 === t ? "</svg>" : "");
        if (!Array.isArray(e) || !e.hasOwnProperty("raw"))
          throw Error("invalid template strings array");
        return [void 0 !== g ? g.createHTML(s) : s, a];
      };
    class B {
      constructor({ strings: e, _$litType$: t }, i) {
        ...
        for (; null !== (a = M.nextNode()) && s.length < n; ) {
          if (1 === a.nodeType) {
            if (a.hasAttributes()) {
              const e = [];
            ...
            if (a.data === w) s.push({ type: 2, index: r });
            else {
              let e = -1;
              for (; -1 !== (e = a.data.indexOf(v, e + 1)); )
                s.push({ type: 7, index: r }), (e += v.length - 1);
            }
          r++;
        }
      }
    ...
    function H(e, t, i = e, a) {
      var r, o, n, s;
      if (t === U) return t;
      let l =
        void 0 !== a
          ? null === (r = i._$Cl) || void 0 === r
            ? void 0
            : r[a]
          : i._$Cu;
      const c = _(t) ? void 0 : t._$litDirective$;
      return (
        (null == l ? void 0 : l.constructor) !== c &&
          (null === (o = null == l ? void 0 : l._$AO) ||
            void 0 === o ||
            o.call(l, !1),
          void 0 === c ? (l = void 0) : ((l = new c(e)), l._$AT(e, i, a)),
          void 0 !== a
            ? ((null !== (n = (s = i)._$Cl) && void 0 !== n
                ? n
                : (s._$Cl = []))[a] = l)
            : (i._$Cu = l)),
        void 0 !== l && (t = H(e, l._$AS(e, t.values), l, a)),
        t
      );
    }
    class O {
        ...
        for (; void 0 !== l; ) {
          if (n === l.index) {
            ...
            2 === l.type
              ...
              : 6 === l.type && (t = new Z(o, this, e)),
              this.v.push(t),
              (l = a[++s]);
          }
          n !== (null == l ? void 0 : l.index) && ((o = M.nextNode()), n++);
        }
        return r;
      }
      m(e) {
    ...
    class N {
      constructor(e, t, i, a) {
        ...
        (this.type = 2),
          ...
          (this.options = a),
          (this._$Cg =
            null === (r = null == a ? void 0 : a.isConnected) ||
            void 0 === r ||
            r);
      }
      get _$AU() {
      ...
      $(e) {
        this._$AH !== R && _(this._$AH)
          ? (this._$AA.nextSibling.data = e)
          : this.S(k.createTextNode(e)),
          (this._$AH = e);
      }
      T(e) {
        var t;
        const { values: i, _$litType$: a } = e,
          r =
            "number" == typeof a
              ? this._$AC(e)
              : (void 0 === a.el && (a.el = B.createElement(a.h, this.options)),
                a);
        if ((null === (t = this._$AH) || void 0 === t ? void 0 : t._$AD) === r)
          this._$AH.m(i);
        else {
          const e = new O(r, this),
            t = e.p(this.options);
      ...
      _$AC(e) {
        ...
        return void 0 === t && q.set(e.strings, (t = new B(e))), t;
      }
      A(e) {
        ...
        for (const r of e)
          a === t.length
            ? t.push((i = new N(this.M(y()), this.M(y()), this, this.options)))
            : (i = t[a]),
            i._$AI(r),
            a++;
      ...
      _$AI(e, t = this, i, a) {
        ...
        if (void 0 === r)
          ...
          for (e = r[0], n = 0; n < r.length - 1; n++)
            (s = H(this, a[i + n], t, n)),
              s === U && (s = this._$AH[n]),
              o || (o = !_(s) || s !== this._$AH[n]),
              s === R
                ? (e = R)
                : e !== R && (e += (null != s ? s : "") + r[n + 1]),
              (this._$AH[n] = s);
        }
        o && !a && this.k(e);
      }
    ...
    class V extends F {
      ...
      _$AI(e, t = this) {
        var i;
        if ((e = null !== (i = H(this, e, t, 0)) && void 0 !== i ? i : R) === U)
          return;
        const a = this._$AH,
          r =
            (e === R && a !== R) ||
    ...
    (X.finalized = !0),
      (X._$litElement$ = !0),
      null === (J = globalThis.litElementHydrateSupport) ||
        void 0 === J ||
        J.call(globalThis, { LitElement: X });
    const ee = globalThis.litElementPolyfillSupport;
    null == ee || ee({ LitElement: X });
    ...
    class oe extends re {
      constructor(e) {
        if ((super(e), (this.it = R), e.type !== ie))
          throw Error(
      ...
      render(e) {
        if (e === R || null == e) return (this.vt = void 0), (this.it = e);
        if (e === U) return e;
        if ("string" != typeof e)
          throw Error(
        ...
        class extends re {
          ...
          update(e, [t]) {
            ...
            for (const e in t) {
              ...
              null != a &&
                (this.ct.add(e),
                e.includes("-") ? i.setProperty(e, a) : (i[e] = a));
            }
            return U;
          }
        }
      );
    var de = __webpack_require__(6274),
      he = __webpack_require__(3029),
      fe = __webpack_require__.n(he);
    const be = r(de.Z);
    function ue(e) {
      return [be, e];
    }
    ...
    `;
      ...
      render() {
        if (!this.svg) return P``;
        const e = {};
        return (
          this.size
            ? ((e.width = this.size), (e.height = this.size))
            : (this.width && (e.width = this.width),
              this.height && (e.height = this.height)),
          P`<svg style="${ce(e)}"><g>${le(this.svg)}</g></svg>`
        );
      }
    }
    customElements.define("fa-icon", ve),
    ...
    <div class="modal is-active">
      <div class="modal-background" @click="${() =>
        !this.noBgClose && this.onClose()}"></div>
    ...
    var we,
      xe = __webpack_require__(8200),
      ke = __webpack_require__.n(xe),
      ye = __webpack_require__(4878),
      _e = __webpack_require__.n(ye),
      $e = __webpack_require__(4124),
      Se = __webpack_require__.n($e);
    function ze(e, t) {
      void 0 === t && (t = {});
      var i = t.registrationOptions;
      void 0 === i && (i = {}), delete t.registrationOptions;
      var a = function (e) {
        for (var i = [], a = arguments.length - 1; a-- > 0; )
          i[a] = arguments[a + 1];
        t && t[e] && t[e].apply(t, i);
      };
    ...
    class Ee {
      constructor({
        name: e = "sw.js",
        scope: t = "./",
        appName: i = "ReplayWeb.page",
        requireSubdomainIframe: a = !1,
      } = {}) {
        (this.name = e),
          (this.scope = t),
          (this.appName = i),
          (this.requireSubdomainIframe = a),
          (this.errorMsg = null);
      }
      setAppName(e) {
        this.appName = e;
      ...
      register() {
        ...
        (this.errorMsg = this.getSWErrorMsg()),
          this.errorMsg && (console.error(this.errorMsg), t(this.errorMsg));
        const a = (e) => {
        ...
        return (
          ze(this.scope + this.name, {
            registrationOptions: { scope: this.scope },
            registered() {
              console.log("Service worker is registered"), e();
            },
            error(e) {
              a(e);
            },
      ...
      getCrossOriginIframeMsg() {
        return this.isCrossOriginIframe()
      ...
      getSWErrorMsg() {
        if (navigator.serviceWorker)
          return this.requireSubdomainIframe && !this.isCrossOriginIframe()
            ? `Sorry, due to security settings, this ${this.appName} embed only be viewed within a subdomain iframe.`
            : null;
        const e = this.getCrossOriginIframeMsg();
        return (
          e ||
          (window.isSecureContext
            ? "MozAppearance" in document.documentElement.style
              ? "Sorry, Service Workers are disabled in Firefox in Private Mode. Please try loading this page in regular mode instead."
              : `Sorry, ${this.appName} won't work in this browser as Service Workers are not supported in this window.\n  Please try a different browser.`
      ...
      renderErrorReport(e, t) {
        const i = this.errorMsg || t;
        return i
          ? P`
    ...
    class Ie extends X {
      constructor(e = "sw.js") {
        super(),
          ...
          (this.pageReplay = !1),
          (this.loadInfo = null),
          (this.swmanager = new Ee({ name: e, appName: this.appName })),
          this.swmanager
            .register()
            .catch(
              () =>
    ...
    `;
      ...
      renderNavBar() {
        return P`
    <a href="#skip-main-target" @click=${
      this.skipMenu
    } class="skip-link">Skip main navigation</a>
    <nav class="navbar has-background-info" aria-label="main">
      <div class="navbar-brand">
        ...
        `
          ...
          <a href="${
            this.homeUrl
          }" class="navbar-item wr-logo-item" aria-labelledby="home">
            <fa-icon id="wrlogo" size="1.0rem" .svg=${
              this.mainLogo
          ...
          <a href="${
            this.collPageUrl
          }" class="no-wrap is-size-6 has-text-black">/&nbsp;&nbsp;<i>${
                  this.collTitle
                }</i></a>
        ...
        <a href="#" role="button" id="menu-button" @click="${
          this.onNavMenu
        }" @keyup="${ge}"
          class="navbar-burger burger ${
            this.navMenuShown ? "is-active" : ""
          }" aria-label="main menu" aria-haspopup="true" aria-expanded="${
          this.navMenuShown
        }">
      ...
      <div class="navbar-menu ${this.navMenuShown ? "is-active" : ""}">
        <div class="navbar-start">
          ${
            pe
              ? P`
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Back" @click="${() =>
              window.history.back()}" @keyup="${ge}">
              <fa-icon size="1.0rem" .svg="${_e()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Back</span>
            </a>
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${() =>
              window.history.forward()}" @keyup="${ge}">
    ...
    -->
    <a href="?terms" @click="${(e) => {
      e.preventDefault(), (this.showAbout = !0);
    }}"class="navbar-item is-size-6">About
    </a>`;
      }
      renderColl() {
        return P`
    ...
    @about-show=${() => (this.showAbout = !0)}></wr-coll>`;
      }
      renderHomeIndex() {
        return P`
      <wr-coll-index>
    ...
    `
      ...
      updated(e) {
        e.has("sourceUrl") && (this.collTitle = null);
      }
      onFavIcons(e) {
        const t = document.querySelector("head"),
          i = document.querySelectorAll("link[rel*='icon']");
        for (const e of i) t.removeChild(e);
        for (const i of e.detail.icons) {
          const e = document.createElement("link");
          (e.rel = i.rel), (e.href = i.href), t.appendChild(e);
        }
      }
      skipMenu(e) {
        e.preventDefault(),
      ...
      initRoute() {
        ...
        let e = this.pageParams.get("state");
        if (e)
          try {
            if (
              ((e = JSON.parse(e)),
              e.ids instanceof Array && e.userId && "open" === e.action)
            )
              return (
                this.pageParams.set("source", "googledrive://" + e.ids[0]),
                this.pageParams.delete("state"),
                void (window.location.search = this.pageParams.toString())
              );
          } catch (e) {
            console.log(e);
          }
        if (this.source) {
          ...
          (e.search = this.pageParams.toString()),
        ...
        if (
          ...
          this.pageParams.has("terms") && (this.showAbout = !0),
          this.pageParams.has("embed") &&
        ...
        this.pageParams.get("baseUrlSourcePrefix") &&
          ...
          this.pageParams.get("basePageUrl") &&
            ...
            (this.loadInfo.extraConfig.baseUrl =
              this.pageParams.get("basePageUrl"))),
          this.pageParams.get("customColl") &&
            (this.loadInfo.customColl = this.pageParams.get("customColl")),
          "1" === this.pageParams.get("noWebWorker") &&
            (this.loadInfo.noWebWorker = !0),
          "1" === this.pageParams.get("noCache") &&
            (this.loadInfo.noCache = !0),
          "1" === this.pageParams.get("hideOffscreen") &&
      ...
      onStartLoad(e) {
        ...
        (t.search = this.pageParams.toString()),
          (this.collPageUrl = t.toString()),
          e.detail.isFile
            ? (window.history.pushState({}, "", this.collPageUrl),
              (this.sourceUrl = e.detail.sourceUrl),
              (this.loadInfo = e.detail))
            : (window.location.search = this.pageParams.toString());
      }
      onCollLoaded(e) {
        (this.loadInfo = null),
          e.detail.collInfo && (this.collTitle = e.detail.collInfo.title),
          e.detail.alreadyLoaded ||
            (e.detail.sourceUrl !== this.sourceUrl &&
              (this.pageParams.set("source", e.detail.sourceUrl),
              (window.location.search = this.pageParams.toString())));
      }
      onTitle(e) {
        e.detail.title &&
          ...
          (this.pageReplay = e.detail.replayTitle),
          (document.title =
            (e.detail.replayTitle ? "Archive of " : "") +
            this.pageTitle +
            " | " +
            this.appName));
      }
    ...
    customElements.define("replay-app-main", Ie);
    var Le = __webpack_require__(8135),
      Te = __webpack_require__.n(Le);
    class Pe extends X {
      constructor() {
        super(),
          (this.fileDisplayName = ""),
          (this.file = null),
          (this.hasNativeFS = !!window.showOpenFilePicker && !pe),
          (this.newFullImport = !1),
          (this.noHead = !1);
      }
      static get properties() {
        return {
      ...
      async onChooseNativeFile() {
        ...
        (this.fileHandle = e),
          (this.file = await e.getFile()),
          (this.fileDisplayName = "file://" + e.name);
      }
      randomId() {
        return (
      ...
      onInput(e) {
        (this.fileDisplayName = e.currentTarget.value),
          this.file &&
            this.fileDisplayName &&
            this.fileDisplayName.startsWith("file://") &&
            ((this.file = null), (this.fileDisplayName = ""));
      }
      static get styles() {
        return ue(o`
    :host {
  ...
  `);
        ...
        <div class="${
          ...
          <form class="is-flex" @submit="${this.onStartLoad}">
            ...
            <div class="field has-addons">
              ...
              <div class="control">
                <button type="submit" class="button is-hidden-mobile is-primary">${
    ...
    customElements.define("wr-chooser", Pe);
    var Ue = __webpack_require__(8600),
      Re = __webpack_require__.n(Ue),
      qe = __webpack_require__(1734),
      Me = __webpack_require__.n(qe),
      je = __webpack_require__(6921),
      Be = __webpack_require__.n(je),
      He = __webpack_require__(8536),
      Oe = __webpack_require__.n(He),
      Ne = __webpack_require__(2804),
      Fe = __webpack_require__.n(Ne);
    class We extends X {
      constructor() {
        super(),
          (this.colls = []),
          ...
          (this.query = ""),
          (this.hideHeader = "1" === localStorage.getItem("index:hideHeader")),
          (this._deleting = {}),
      ...
      updated(e) {
        e.has("hideHeader") &&
          ...
          (e.has("colls") || e.has("query")) && this.filter();
      }
      filter() {
        if (this.query) {
          this.filteredColls = [];
          for (const e of this.colls)
            (e.sourceUrl.indexOf(this.query) >= 0 ||
              e.filename.indexOf(this.query) >= 0 ||
              (e.loadUrl && e.loadUrl.indexOf(this.query) >= 0) ||
              (e.title && e.title.indexOf(this.query) >= 0)) &&
              this.filteredColls.push(e);
        } else this.filteredColls = this.colls;
      }
      async loadColls() {
        const e = await fetch(`./w/api/coll-index?${this.indexParams}`);
        try {
          if (200 !== e.status) throw new Error("Invalid API Response, Retry");
          const t = await e.json();
          (this.colls = t.colls.map(
            (e) => ((e.title = e.title || e.filename), e)
          )),
            (this._deleting = {}),
            (this.sortedColls = []);
        } catch (e) {
      ...
      async onDeleteColl(e) {
        if ((e.preventDefault(), e.stopPropagation(), !this.sortedColls))
          return;
        const t = Number(e.currentTarget.getAttribute("data-coll-index")),
          i = this.sortedColls[t];
        if (!i || this._deleting[i.sourceUrl]) return;
        (this._deleting[i.sourceUrl] = !0), this.requestUpdate();
        const a = await fetch(`./w/api/c/${i.id}`, { method: "DELETE" });
        if (200 === a.status) {
    ...
    `;
      ...
      renderHeader() {
        return P`<h2 class="panel-heading panel-color"><span>${this.headerName}</span></h2>`;
      }
      renderSearchHeader() {
        return "";
      }
      render() {
        const e = this.childElementCount > 0;
        return P`
      ...
      <div class="panel">
        ...
        ${this.renderSearchHeader()}
          <div class="control has-icons-left has-addons">
            <input type="text" class="input is-small" @input="${(e) =>
              (this.query = e.currentTarget.value)}" .value="${
                this.query
              }" type="text"
        ...
        ${
          null === this.sortedColls
            ? P`<i>Loading Archives...</i>`
            : this.renderEmpty()
        }
        </div>
        `
    ...
    `;
      ...
      renderCollInfo(e) {
        return P`<wr-coll-info .coll=${e}></wr-coll-info>`;
      }
      renderEmpty() {
        return P`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`;
      }
    }
    class Ge extends X {
      constructor() {
        super(), (this.detailed = !1), (this.canDelete = !1);
      }
      static get properties() {
        return {
          coll: { type: Object },
  ...
  <div class="column is-4">
    ...
    ${
      e.sourceUrl &&
      (e.sourceUrl.startsWith("http://") || e.sourceUrl.startsWith("https://"))
        ? P`
    ...
    <a @click="${(t) =>
      this.onCopy(t, e.sourceUrl)}" class="copy"><fa-icon .svg="${Me()}"/></a>
    ${
  ...
  <div class="column is-2"><p class="minihead">Date Loaded</p>${
    e.ctime ? new Date(e.ctime).toLocaleString() : ""
  }</div>
  <div class="column is-2"><p class="minihead">Total Size</p>${Re()(
    Number(e.size || 0)
  )}</div>
  `;
      }
    ...
    <div class="columns">
      ...
      <div class="columns">
        ...
        <div class="column">
          ...
          ${
            s
              ? P`<span><a target="_blank" href="${s}">View Certificate</a></span>`
              : ""
          }
        </div>
        `
        ...
        <div class="column">
          ...
          ${
            t > 0 || i > 0
              ? P`
          <p>${t} hashes verified${i ? P`, ${i} invalid` : ""}</p>`
              : P`
          Not Available`
          }
        </div>
      ...
      onPurge(e) {
        const t = { reload: e };
        this.dispatchEvent(new CustomEvent("coll-purge", { detail: t }));
      }
    }
    function Ke(e) {
      if (!e) return "";
      e.length < 14 && (e += "00000101000000".substr(e.length));
      const t =
        e.substring(0, 4) +
        "-" +
        e.substring(4, 6) +
    ...
    function Ve(e) {
      ...
      const i = t && !isNaN(t) ? Ze(t.toISOString()) : "";
      return { date: t, timestamp: i };
    }
    function Ze(e) {
    ...
    function Qe(e, t, i) {
      ...
      return (
        a.set("view", e), a.set("url", t), a.set("ts", i), "#" + a.toString()
      );
    }
    async function Je(e) {
      const t = await (async function (e, t) {
        const i = new TextEncoder().encode(e),
          a = await crypto.subtle.digest(t, i),
          r = Array.from(new Uint8Array(a))
            .map((e) => e.toString(16).padStart(2, "0"))
            .join("");
        return r;
      })(e, "SHA-256");
      return { url: e, coll: "id-" + t.slice(0, 12) };
    }
    customElements.define("wr-coll-info", Ge),
      customElements.define("wr-coll-index", We);
    var Ye = __webpack_require__(5056),
      Xe = __webpack_require__.n(Ye),
      et = __webpack_require__(5732),
      tt = __webpack_require__.n(et),
      it = __webpack_require__(8561),
      at = __webpack_require__.n(it),
      rt = __webpack_require__(9885),
      ot = __webpack_require__.n(rt),
      nt = __webpack_require__(4636),
      st = __webpack_require__.n(nt),
      lt = __webpack_require__(1615),
      ct = __webpack_require__.n(lt),
      dt = __webpack_require__(2302),
      ht = __webpack_require__.n(dt),
      ft = __webpack_require__(6368),
      bt = __webpack_require__.n(ft),
      ut = __webpack_require__(9125),
      pt = __webpack_require__.n(ut),
      mt = __webpack_require__(9998),
      gt = __webpack_require__.n(mt),
      vt = __webpack_require__(2164),
      wt = __webpack_require__.n(vt),
      xt = __webpack_require__(426),
      kt = __webpack_require__.n(xt),
      yt = __webpack_require__(430),
      _t = __webpack_require__.n(yt),
      $t = __webpack_require__(1795),
      St = __webpack_require__.n($t),
      zt = __webpack_require__(7529),
      Ct = __webpack_require__.n(zt),
      At = __webpack_require__(6873),
      Dt = __webpack_require__.n(At),
      Et = __webpack_require__(4575),
      It = __webpack_require__.n(Et);
    class Lt extends X {
      constructor() {
        super(),
          (this.collInfo = null),
    ...
    `;
      ...
      onEmbedDrop(e) {
        e.stopPropagation(), (this.active = !this.active);
      }
    }
    customElements.define("rwp-embed-receipt", Lt);
    var Tt = "undefined" != typeof window ? window : null,
      Pt = null === Tt,
      Ut = Pt ? void 0 : Tt.document,
      Rt = "horizontal",
      qt = function () {
        return !1;
      },
    ...
    const Gt = function (e, t) {
        ...
        var c = Bt(l[0]).parentNode,
          ...
          g = Ht(t, "expandToMin", !1),
          v = Ht(t, "gutterSize", 10),
          w = Ht(t, "gutterAlign", "center"),
          x = Ht(t, "snapOffset", 30),
          k = Ht(t, "dragInterval", 1),
          y = Ht(t, "direction", Rt),
          _ = Ht(t, "cursor", y === Rt ? "col-resize" : "row-resize"),
          $ = Ht(t, "gutter", Nt),
          S = Ht(t, "elementStyle", Ft),
          z = Ht(t, "gutterStyle", Wt);
        function C(e, t, a, r) {
          var o = S(i, t, a, r);
        ...
        function D(e) {
          return "touches" in e ? e.touches[0][a] : e[a];
        }
        function E(e) {
          var t = s[this.a],
            i = s[this.b],
            a = t.size + i.size;
          (t.size = (e / this.size) * a),
            (i.size = a - (e / this.size) * a),
            C(t.element, t.size, this._b, t.i),
            C(i.element, i.size, this._c, i.i);
        }
        function I(e) {
          var i,
            a = s[this.a],
            r = s[this.b];
          this.dragging &&
            ((i = D(e) - this.start + (this._b - this.dragOffset)),
            k > 1 && (i = Math.round(i / k) * k),
            i <= a.minSize + x + this._b
              ? (i = a.minSize + this._b)
              : i >= this.size - (r.minSize + x + this._c) &&
                (i = this.size - (r.minSize + this._c)),
            i >= a.maxSize - x + this._b
              ? (i = a.maxSize + this._b)
              : i <= this.size - (r.maxSize - x + this._c) &&
                (i = this.size - (r.maxSize + this._c)),
            E.call(this, i),
            Ht(t, "onDrag", qt)(A()));
        }
        function L() {
          var e = s[this.a].element,
            t = s[this.b].element,
            a = e.getBoundingClientRect(),
            n = t.getBoundingClientRect();
          (this.size = a[i] + n[i] + this._b + this._c),
            (this.start = a[r]),
            (this.end = a[o]);
        }
        function T(e) {
          ...
          var i = 0,
            ...
            r = e.map(function (r, o) {
              var n = (t * r) / 100,
                s = Ot(v, 0 === o, o === e.length - 1, w),
                l = u[o] + s;
              return n < l ? ((i += l - n), a.push(0), l) : (a.push(n - l), n);
            });
          return 0 === i
            ? e
            : r.map(function (e, r) {
        ...
        function P() {
          var e = this,
            i = s[e.a].element,
            a = s[e.b].element;
          e.dragging && Ht(t, "onDragEnd", qt)(A()),
            (e.dragging = !1),
            Tt.removeEventListener("mouseup", e.stop),
            Tt.removeEventListener("touchend", e.stop),
            Tt.removeEventListener("touchcancel", e.stop),
            Tt.removeEventListener("mousemove", e.move),
            Tt.removeEventListener("touchmove", e.move),
            (e.stop = null),
            (e.move = null),
            i.removeEventListener("selectstart", qt),
            i.removeEventListener("dragstart", qt),
            a.removeEventListener("selectstart", qt),
            a.removeEventListener("dragstart", qt),
            (i.style.userSelect = ""),
        ...
        function U(e) {
          if (!("button" in e) || 0 === e.button) {
            var i = this,
              a = s[i.a].element,
              r = s[i.b].element;
            i.dragging || Ht(t, "onDragStart", qt)(A()),
              e.preventDefault(),
              (i.dragging = !0),
              (i.move = I.bind(i)),
              (i.stop = P.bind(i)),
              Tt.addEventListener("mouseup", i.stop),
              Tt.addEventListener("touchend", i.stop),
              Tt.addEventListener("touchcancel", i.stop),
              Tt.addEventListener("mousemove", i.move),
              Tt.addEventListener("touchmove", i.move),
              a.addEventListener("selectstart", qt),
              a.addEventListener("dragstart", qt),
              r.addEventListener("selectstart", qt),
              r.addEventListener("dragstart", qt),
              ...
              (i.gutter.style.cursor = _),
              (i.parent.style.cursor = _),
              (Ut.body.style.cursor = _),
              L.call(i),
              (i.dragOffset = D(e) - i.end);
          }
        }
        y === Rt
          ? ((i = "width"),
        ...
        function q(e) {
          var t = e.i === R.length,
            i = t ? R[e.i - 1] : R[e.i];
          L.call(i);
          var a = t ? i.size - e.minSize - i._c : e.minSize + i._b;
          E.call(i, a);
        }
        return (
          (s = l.map(function (e, t) {
            ...
            if (
              ...
              (a._c = Ot(v, !1, t === l.length - 1, w)),
              "row-reverse" === h || "column-reverse" === h)
            ) {
              var o = a.a;
              (a.a = a.b), (a.b = o);
            }
            if (t > 0) {
              ...
              !(function (e, t, a) {
                ...
                (a._a = U.bind(a)),
                n.addEventListener("mousedown", a._a),
                n.addEventListener("touchstart", a._a),
                c.insertBefore(n, r.element),
                (a.gutter = n);
            }
            return (
              C(r.element, r.size, Ot(v, 0 === t, t === l.length - 1, w), t),
              t > 0 && R.push(a),
              r
            );
          })),
          s.forEach(function (e) {
            var t = e.element.getBoundingClientRect()[i];
            t < e.minSize && (g ? q(e) : (e.minSize = t));
          }),
          {
            setSizes: function (e) {
              var t = T(e);
              t.forEach(function (e, i) {
                if (i > 0) {
                  ...
                  (r.size = t[i - 1]),
                    (o.size = e),
                    C(r.element, r.size, a._b, r.i),
                    C(o.element, o.size, a._c, o.i);
                }
              });
            },
            getSizes: A,
            ...
            destroy: function (e, t) {
              R.forEach(function (a) {
                if (
                  (!0 !== t
                    ? a.parent.removeChild(a.gutter)
                    : (a.gutter.removeEventListener("mousedown", a._a),
                      a.gutter.removeEventListener("touchstart", a._a)),
                  !0 !== e)
                ) {
                  var r = S(i, a.a.size, a._b);
                  Object.keys(r).forEach(function (e) {
                    (s[a.a].element.style[e] = ""),
                      (s[a.b].element.style[e] = "");
                  });
                }
              });
            },
    ...
    class Vt extends X {
      constructor() {
        super(),
          ...
          (this.menuActive = !1),
          (this.embedDropdownActive = !1),
          (this.hasStory = !1),
          (this.editable = !1),
          (this.browsable = !0),
          (this.clearable = !0),
          (this.showSidebar =
            "1" === localStorage.getItem("pages:showSidebar")),
          (this.splitter = null),
          (this.isVisible = !0),
          (this.favIconUrl = ""),
      ...
      static get properties() {
        return {
          inited: { type: Boolean },
          sourceUrl: { type: String },
          loadInfo: { type: Object, attribute: !1 },
          showSidebar: { type: Boolean },
          collInfo: { type: Object, attribute: !1 },
          coll: { type: String },
          hasStory: { type: Boolean },
          isLoading: { type: Boolean },
          tabData: { type: Object, attribute: !1 },
          url: { type: String },
          ts: { type: String },
      ...
      async runUpdateLoop() {
        try {
          for (
            ...
            (!this.collInfo || this.collInfo.pages.length < 100);

          )
            await new Promise((e) =>
              setTimeout(e, 1e3 * this.autoUpdateInterval)
            ),
              await this.doUpdateInfo(!0);
        } finally {
          this._autoUpdater = null;
        }
      }
      updated(e) {
        if (
          (e.has("sourceUrl") && this.doUpdateInfo(),
          e.has("editable") &&
            this.editable &&
            this.autoUpdateInterval &&
            !this._autoUpdater &&
          ...
          if (!this.collInfo || !this.collInfo.coll) return;
          Object.keys(this.tabData).forEach(
            (e) => !this.tabData[e] && delete this.tabData[e]
          );
          const t = "#" + new URLSearchParams(this.tabData).toString();
          if (
            (this.tabData.url ||
              (this.url =
                Kt + decodeURIComponent(this._paramsToString(this.tabData))),
            t !== this._locationHash)
          ) {
            if (
              ((this._locationHash = t),
              this._replaceLoc || 0 === Object.keys(e.get("tabData")).length)
            ) {
              const e = new URL(window.location.href);
              (e.hash = this._locationHash),
                window.history.replaceState({}, "", e.href),
                (this._replaceLoc = !1);
            } else if (
              ((window.location.hash = this._locationHash), !this.showSidebar)
            ) {
              const e = this.renderRoot.querySelector("wr-coll-replay");
              e && e.focus();
            }
            this.embed &&
        ...
        e.has("showSidebar") &&
          (this.embed ||
            localStorage.setItem(
              "pages:showSidebar",
              this.showSidebar ? "1" : "0"
            )),
          (e.has("tabData") || e.has("showSidebar")) &&
            this.configureSplitter();
      }
      configureSplitter() {
        if (this.tabData.url && this.showSidebar) {
          const e = this.renderRoot.querySelector("#contents"),
            t = this.renderRoot.querySelector("wr-coll-replay");
          if (e && t && !this.splitter) {
            const i = {
              sizes: [30, 70],
              minSize: [300, 300],
              gutterSize: 4,
              onDragStart() {
                t.setDisablePointer(!0);
              },
              onDragEnd() {
                t.setDisablePointer(!1);
              },
            };
            this.splitter = Gt([e, t], i);
          }
      ...
      async doUpdateInfo(e = !1) {
        if (e && this.tabData.url && !this.showSidebar) return;
        let t = this.loadInfo && this.loadInfo.customColl;
        if (!t) {
          t = (await Je(this.sourceUrl)).coll;
        }
        this.coll = t;
        const i = "./w/api/c/" + t,
          a = "./w/" + t,
        ...
        this.collInfo.title || (this.collInfo.title = this.collInfo.filename),
          ...
          this.dispatchEvent(
            new CustomEvent("coll-loaded", {
              detail: { collInfo: this.collInfo, alreadyLoaded: !0 },
            })
          ),
          this.onHashChange();
      }
      onCollLoaded(e) {
        this.doUpdateInfo(),
          (this.loadInfo = null),
          e.detail.sourceUrl && (this.sourceUrl = e.detail.sourceUrl),
          this.dispatchEvent(
            new CustomEvent("coll-loaded", {
              detail: { sourceUrl: this.sourceUrl, collInfo: this.collInfo },
            })
          );
      }
      onCollUpdate(e) {
        this.editable && (this.collInfo = { ...this.collInfo, ...e.detail });
      }
      onHashChange() {
        const e = window.location.hash;
        if (
          (e &&
            e !== this._locationHash &&
            ((this.tabData = Object.fromEntries(
              new URLSearchParams(e.slice(1)).entries()
            )),
            (this._locationHash = e)),
          this.collInfo.coll && !this.tabNames.includes(this.tabData.view))
        ) {
          const e = this.hasStory
            ? "story"
            : this.editable || this.collInfo.pages.length
            ? "pages"
            : "resources";
          this.tabData = { ...this.tabData, view: e };
        }
        if (this.tabData.url && this.tabData.url.startsWith("page:")) {
          const e = Number(this.tabData.url.slice("page:".length));
          if (!isNaN(e) && e < this.collInfo.pages.length) {
            const t = this.collInfo.pages[e];
            (this.tabData.url = t.url), (this.tabData.ts = Ve(t).timestamp);
          }
        }
        this.hasStory ||
          "story" !== this.tabData.view ||
          (this.tabData.view = "pages"),
          this.tabData.url && this.tabData.query && (this.showSidebar = !0);
      }
      onTabClick(e) {
        e.preventDefault();
        const t = e.currentTarget.getAttribute("href");
        return (this.tabData = { ...this.tabData, view: t.slice(1) }), !1;
      }
      onCollTabNav(e) {
        e.detail.reload
          ? this.onRefresh(null, !0)
          : e.target.id === this.tabData.view ||
            ("replay" === e.target.id && this.tabData.url)
          ? this.updateTabData(e.detail.data, e.detail.replaceLoc, !1)
          : this.showSidebar &&
            this.tabData.url &&
            this.updateTabData(e.detail.data, e.detail.replaceLoc, !0);
      }
      updateTabData(e, t = !1) {
        (this.tabData = { ...this.tabData, ...e }),
          this.tabData.url && (this.url = this.tabData.url || ""),
          this.tabData.ts && (this.ts = this.tabData.ts || ""),
          (this._replaceLoc = !this._locUpdateNeeded && t),
          (this._locUpdateNeeded = !0);
      }
      static get styles() {
        return ue(Vt.compStyles);
      }
      static get compStyles() {
        return o`
    :host {
    ...
    `;
      ...
      render() {
        if (!this.inited) return P``;
        const e = !!this.tabData.url,
          t = e && this.showSidebar;
        if (!e && this.tabData && this.tabData.view) {
          const e = {
        ...
        return this.collInfo && !this.collInfo.coll
          ? P`
      ...
      <div id="tabContents">
        <div id="contents" class="is-light ${
          t ? "sidebar" : e ? "is-hidden" : "full-pages"
        }"
             role="${t ? "complementary" : ""}" aria-label="${
              t ? "Browse Contents" : ""
            }">
      ...
      renderTabHeader(e) {
        return P`
      <nav class="main tabs is-centered ${
        e ? "sidebar" : ""
      }" aria-label="tabs">
        <ul>
          ${
          ...
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${
              this.onHideSidebar
            }" @keyup="${ge}" class="is-marginless is-size-6 is-paddingless">
          ...
          <li class="${"story" === this.tabData.view ? "is-active" : ""}">
            <a @click="${
              this.onTabClick
            }" href="#story" class="is-size-6" aria-label="Story" aria-current="${
                  "story" === this.tabData.view ? "location" : ""
                }">
              <span class="icon"><fa-icon .svg="${Xe()}" aria-hidden="true" title="Story"></fa-icon></span>
              <span class="tab-label ${
                e ? "is-hidden" : ""
              }" title="Story">Story</span>
            </a>
          </li>`
              : ""
          }
          ...
          <li class="${"pages" === this.tabData.view ? "is-active" : ""}">
            <a @click="${
              this.onTabClick
            }" href="#pages" class="is-size-6" aria-label="Pages" aria-current="${
          "pages" === this.tabData.view ? "location" : ""
        }">
          ...
          <li class="${"resources" === this.tabData.view ? "is-active" : ""}">
            <a @click="${
              this.onTabClick
            }" href="#resources" class="is-size-6" aria-label="URLs" aria-current="${
          "resources" === this.tabData.view ? "location" : ""
        }">
              <span class="icon"><fa-icon .svg="${ot()}" aria-hidden="true" title="URLs"></fa-icon></span>
              <span class="tab-label ${
                e ? "is-hidden" : ""
              }" title="URLs">URLs</span>
            </a>
          </li>
          ...
          <li class="${"info" === this.tabData.view ? "is-active" : ""}">
            <a @click="${
              this.onTabClick
            }" href="#info" class="is-size-6" aria-label="Archive Info" aria-current="${
          "info" === this.tabData.view ? "location" : ""
        }">
              <span class="icon"><fa-icon .svg="${ct()}" aria-hidden="true" title="Archive Info"></fa-icon></span>
              <span class="tab-label ${
                e ? "is-hidden" : ""
              }" title="Archive Info">Info</span>
            </a>
          </li>
      ...
      renderLocationBar() {
        if ("replayonly" === this.embed || "replay-with-info" == this.embed)
          return "";
        const e = Ke(this.ts).toLocaleString(),
          t = !!this.tabData.url,
          i = t && this.favIconUrl;
        return P`
    <a class="skip-link" href="#skip-replay-target" @click="${
      this.skipMenu
    }">Skip replay navigation</a>
    <nav class="replay-bar" aria-label="replay">
      <div class="field has-addons">
        <a href="#" role="button" class="button narrow is-borderless is-hidden-touch" id="fullscreen" @click="${
          this.onFullscreenToggle
        }" @keyup="${ge}"
                title="${
                  this.isFullscreen ? "Exit Full Screen" : "Full Screen"
                }" aria-label="${
          this.isFullscreen ? "Exit Fullscreen" : "Fullscreen"
        }">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${
              this.isFullscreen ? gt() : pt()
            }"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${
          this.onGoBack
        }" @keyup="${ge}"
        ...
        <a href="#" role="button" class="button narrow is-borderless ${
          this.isLoading ? "is-loading" : "is-hidden-mobile"
        }" id="refresh" @click="${this.onRefresh}" @keyup="${ge}"
        ...
        ${
          this.browsable
            ? P`
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile ${
          t ? "" : "grey-disabled"
        }" @click="${this.onShowPages}" @keyup="${ge}"
        ...
        <form @submit="${this.onSubmit}">
          <div class="control is-expanded ${i ? "has-icons-left" : ""}">
            <input id="url" class="input" type="text" @keydown="${
              this.onKeyDown
            }" @blur="${this.onLostFocus}" .value="${
          this.url
        }" placeholder="Enter text to search or a URL to replay"/>
            ${
              t
                ? P`<p id="datetime" class="control is-hidden-mobile">${e}</p>`
                : P``
            }
            ${
              i
        ...
        <div class="dropdown is-right ${
          ...
          <div class="dropdown-trigger">
            <button class="button is-borderless" aria-haspopup="true" aria-controls="menu-dropdown" aria-expanded="${
              this.menuActive
            }" @click="${this.onMenu}"
          ...
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              <a href="#" role="button" class="dropdown-item is-hidden-desktop" @click="${
                this.onFullscreenToggle
              }" @keyup="${ge}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${
              ...
              <a href="#" role="button" class="dropdown-item is-hidden-tablet" @click="${
                this.onGoBack
              }" @keyup="${ge}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${_e()}"></fa-icon>
              ...
              ${
                this.browsable
                  ? P`
              <a href="#" role="button" class="dropdown-item is-hidden-tablet ${
                t ? "" : "grey-disabled"
              }" @click="${this.onShowPages}" @keyup="${ge}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${at()}"></fa-icon>
              ...
              <a href="#" role="button" class="dropdown-item" @click="${
                this.onPurgeCache
              }" @keyup="${ge}">
                <span class="icon is-small">
              ...
              <a href="${
                this.sourceUrl
              }" role="button" class="dropdown-item" @keyup="${ge}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${tt()}"></fa-icon>
                </span>
                <span>Download Archive</span>
              ...
              <a href="#" role="button" class="dropdown-item" @click="${
                ...
                <fa-icon class="menu-logo" size="1.0rem" aria-hidden="true" .svg=${
                  this.appLogo
                }></fa-icon>
      ...
      renderVerifyInfo() {
        return "replay-with-info" !== this.embed
          ? ""
          : P`<rwp-embed-receipt
            .collInfo=${this.collInfo}
            url=${this.url}
      ...
      dragStart() {
        const e = this.renderRoot.querySelector("wr-coll-replay");
        e && e.setDisablePointer(!0);
      }
      dragEnd() {
        const e = this.renderRoot.querySelector("wr-coll-replay");
        e && e.setDisablePointer(!1);
      }
      renderCollInfo() {
        return P`
    <div class="info-bg">
      ...
      renderCollTabs(e) {
        const t = this.hasStory && "story" === this.tabData.view,
          i = "pages" === this.tabData.view,
          a = "resources" === this.tabData.view,
          r = "info" === this.tabData.view;
        return P`
    ...
    `;
      ...
      onKeyDown(e) {
        ("Esc" !== e.key && "Escape" !== e.key) ||
          (e.preventDefault(), (e.currentTarget.value = this.url));
      }
      onMenu(e) {
        e.stopPropagation(),
      ...
      onGoBack(e) {
        e.preventDefault(), (this.menuActive = !1), window.history.back();
      }
      onGoForward(e) {
        e.preventDefault(), (this.menuActive = !1), window.history.forward();
      }
      onShowPages(e) {
        e.preventDefault(),
          this.showSidebar || document.documentElement.clientWidth >= 769
            ? (this.showSidebar = !this.showSidebar)
            : ((this.showSidebar = !1),
              this.updateTabData({ url: "", ts: "" }));
      }
      onFullPageView(e) {
        e.preventDefault(), this.updateTabData({ url: "", ts: "" });
      }
      onHideSidebar(e) {
        e.preventDefault(), (this.showSidebar = !1);
      }
      async onFavIcons(e) {
        for (const t of e.detail.icons) {
          const e = await fetch(t.href);
          if (200 === e.status) {
            const i = e.headers.get("Content-Type");
            if (i && !i.startsWith("text/"))
              return void (this.favIconUrl = t.href);
          }
        }
        this.favIconUrl = "";
      }
      onPurgeCache(e) {
        e.preventDefault();
        const t = !e.detail || void 0 === e.detail.reload || e.detail.reload;
        this.deleteFully(t);
      }
      async deleteFully(e = !1) {
        const t = this.collInfo.apiPrefix + (e ? "?reload=1" : ""),
          i = await fetch(t, { method: "DELETE" });
        200 !== i.status && console.warn("purge failed: " + i.status),
          e || this.embed
      ...
      onSubmit(e) {
        ...
        return t.value ? this.navigateTo(t.value) : (t.value = this.url), !1;
      }
      onLostFocus(e) {
        e.currentTarget.value || (e.currentTarget.value = this.url);
      }
      navigateTo(e) {
        let t;
        if (e.startsWith("http://") || e.startsWith("https://")) {
          if (((t = { url: e }), e === this.tabData.url)) {
            const e = this.renderRoot.querySelector("wr-coll-replay");
            return void (e && e.refresh());
          }
        } else
          t = e.startsWith(Kt)
            ? this._stringToParams(e)
            : { query: e, view: "pages" };
        this.updateTabData(t);
      }
      _stringToParams(e) {
        const t = new URLSearchParams(e.slice(Kt.length)),
          i = { url: "", ts: "" };
        for (const e of [
          "query",
          "view",
      ...
      onRefresh(e, t = !1) {
        if (
          (e && e.preventDefault(), (this.menuActive = !1), this.tabData.url)
        ) {
          const e = this.renderRoot.querySelector("wr-coll-replay");
          e && e.refresh();
        } else t || window.location.reload();
      }
      onAbout() {
    ...
    customElements.define("wr-coll", Vt);
    let Qt = {
      baseUrl: null,
      breaks: !1,
      extensions: null,
    ...
    function ai(e, t) {
      if (t) {
        if (Jt.test(e)) return e.replace(Yt, ii);
      } else if (Xt.test(e)) return e.replace(ei, ii);
      return e;
    }
    const ri = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;
    function oi(e) {
      return e.replace(ri, (e, t) =>
    ...
    function si(e, t) {
      ...
      const i = {
        replace: (t, a) => (
          (a = (a = a.source || a).replace(ni, "$1")), (e = e.replace(t, a)), i
        ),
    ...
    function di(e, t, i) {
      if (e) {
        let e;
        try {
          e = decodeURIComponent(oi(i)).replace(li, "").toLowerCase();
        } catch (e) {
          return null;
        }
        if (
    ...
    const hi = {},
      ...
      bi = /^([^:]+:)[\s\S]*$/,
      ui = /^([^:]+:\/*[^/]*)[\s\S]*$/;
    const pi = { exec: function () {} };
    function mi(e) {
      let t,
        i,
        a = 1;
      for (; a < arguments.length; a++)
        for (i in ((t = arguments[a]), t))
    ...
    function gi(e, t) {
      ...
      for (; a < i.length; a++) i[a] = i[a].trim().replace(/\\\|/g, "|");
      return i;
    }
    function vi(e, t, i) {
      const a = e.length;
      ...
      let r = 0;
      for (; r < a; ) {
        const o = e.charAt(a - r - 1);
        if (o !== t || i) {
          if (o === t || !i) break;
          r++;
        } else r++;
      }
      return e.substr(0, a - r);
    }
    function wi(e) {
      e &&
        e.sanitize &&
    ...
    function ki(e, t, i, a) {
      ...
      if ("!" !== e[0].charAt(0)) {
        ...
        const e = {
          ...
          title: o,
          text: n,
          tokens: a.inlineTokens(n, []),
        };
        return (a.state.inLink = !1), e;
      }
      return { type: "image", raw: i, href: r, title: o, text: ai(n) };
    }
    class yi {
      constructor(e) {
        this.options = e || Qt;
      ...
      code(e) {
        ...
        if (t) {
          ...
          return {
            ...
            text: this.options.pedantic ? e : vi(e, "\n"),
          };
        }
      }
      fences(e) {
            ...
            i = (function (e, t) {
              ...
              return t
                ...
                .map((e) => {
                  ...
                  if (null === t) return e;
                  const [i] = t;
                  return i.length >= a.length ? e.slice(a.length) : e;
                })
                .join("\n");
            })(e, t[3] || "");
          return {
      ...
      list(e) {
        ...
        if (t) {
          ...
          (u = p ? `\\d{1,9}\\${u.slice(-1)}` : `\\${u}`),
            this.options.pedantic && (u = p ? u : "[*+-]");
          const g = new RegExp(`^( {0,3}${u})((?: [^\\n]*)?(?:\\n|$))`);
          for (
            ;
            e && ((b = !1), (t = g.exec(e))) && !this.rules.block.hr.test(e);
          ...
          (m.items[m.items.length - 1].raw = i.trimRight()),
            (m.items[m.items.length - 1].text = f.trimRight()),
            (m.raw = m.raw.trimRight());
          const v = m.items.length;
          for (n = 0; n < v; n++) {
            (this.lexer.state.top = !1),
              (m.items[n].tokens = this.lexer.blockTokens(m.items[n].text, []));
            const e = m.items[n].tokens.filter((e) => "space" === e.type),
              t = e.every((e) => {
                const t = e.raw.split("");
                let i = 0;
                for (const e of t)
          ...
          if (e.header.length === e.align.length) {
            ...
            for (i = 0; i < n; i++)
              /^ *-+: *$/.test(e.align[i])
                ...
                ? (e.align[i] = "left")
                : (e.align[i] = null);
            for (n = e.rows.length, i = 0; i < n; i++)
              e.rows[i] = gi(e.rows[i], e.header.length).map((e) => ({
                text: e,
              }));
            for (n = e.header.length, a = 0; a < n; a++)
              (e.header[a].tokens = []),
                this.lexer.inlineTokens(e.header[a].text, e.header[a].tokens);
            for (n = e.rows.length, a = 0; a < n; a++)
              for (o = e.rows[a], r = 0; r < o.length; r++)
                (o[r].tokens = []),
      ...
      escape(e) {
        ...
        if (t) return { type: "escape", raw: t[0], text: ai(t[1]) };
      }
      tag(e) {
          ...
          if (!this.options.pedantic && /^</.test(e)) {
            ...
            const e = (function (e, t) {
              ...
              for (; r < i; r++)
                ...
                else if (e[r] === t[1] && (a--, a < 0)) return r;
              return -1;
            })(t[2], "()");
            if (e > -1) {
      ...
      reflink(e, t) {
        ...
        if (
          ...
          return ki(i, e, i[0], this.lexer);
        }
      }
      emStrong(e, t, i = "") {
        let a = this.rules.inline.emStrong.lDelim.exec(e);
        if (!a) return;
        if (a[3] && i.match(/[\p{L}\p{N}]/u)) return;
        const r = a[1] || a[2] || "";
        if (!r || (r && ("" === i || this.rules.inline.punctuation.exec(i)))) {
          ...
          for (
            ...
            if (((r = a[1] || a[2] || a[3] || a[4] || a[5] || a[6]), !r))
              continue;
            if (((o = r.length), a[3] || a[4])) {
              n += o;
              continue;
            }
            if ((a[5] || a[6]) && i % 3 && !((i + o) % 3)) {
              s += o;
              continue;
            }
            if (((n -= o), n > 0)) continue;
            if (((o = Math.min(o, o + n + s)), Math.min(i, o) % 2)) {
              const t = e.slice(1, i + a.index + o);
              return {
                type: "em",
                raw: e.slice(0, i + a.index + o + 1),
                text: t,
                tokens: this.lexer.inlineTokens(t, []),
              };
            }
            const t = e.slice(2, i + a.index + o - 1);
            return {
              type: "strong",
              raw: e.slice(0, i + a.index + o + 1),
              text: t,
      ...
      autolink(e, t) {
        ...
        if (i) {
          ...
          return (
            "@" === i[2]
              ? ((e = ai(this.options.mangle ? t(i[1]) : i[1])),
                (a = "mailto:" + e))
              : ((e = ai(i[1])), (a = e)),
            {
              type: "link",
      ...
      url(e, t) {
        ...
        if ((i = this.rules.inline.url.exec(e))) {
          let e, a;
          if ("@" === i[2])
            (e = ai(this.options.mangle ? t(i[0]) : i[0])), (a = "mailto:" + e);
          else {
            let t;
            do {
              (t = i[0]), (i[0] = this.rules.inline._backpedal.exec(i[0])[0]);
            } while (t !== i[0]);
            (e = ai(i[0])), (a = "www." === i[1] ? "http://" + e : e);
          }
          return {
            type: "link",
            raw: i[0],
            ...
            (e = this.lexer.state.inRawBlock
              ? this.options.sanitize
                ? this.options.sanitizer
                  ...
                  : ai(i[0])
                : i[0]
              : ai(this.options.smartypants ? t(i[0]) : i[0])),
    ...
    (_i.def = si(_i.def)
      .replace("label", _i._label)
      .replace("title", _i._title)
      .getRegex()),
      (_i.bullet = /(?:[*+-]|\d{1,9}[.)])/),
      (_i.listItemStart = si(/^( *)(bull) */)
        .replace("bull", _i.bullet)
        .getRegex()),
      (_i.list = si(_i.list)
        .replace(/bull/g, _i.bullet)
        .replace(
          "hr",
          "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))"
        )
      ...
      (_i._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/),
      (_i.html = si(_i.html, "i")
        .replace("comment", _i._comment)
        .replace("tag", _i._tag)
        .replace(
          "attribute",
          / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/
      ...
      (_i.paragraph = si(_i._paragraph)
        ...
        .replace("tag", _i._tag)
        .getRegex()),
      (_i.blockquote = si(_i.blockquote)
        .replace("paragraph", _i.paragraph)
        .getRegex()),
      (_i.normal = mi({}, _i)),
      (_i.gfm = mi({}, _i.normal, {
        table:
      ...
      (_i.gfm.table = si(_i.gfm.table)
        ...
        .replace("tag", _i._tag)
        .getRegex()),
      (_i.gfm.paragraph = si(_i._paragraph)
        .replace("hr", _i.hr)
        .replace("heading", " {0,3}#{1,6} ")
        .replace("|lheading", "")
        .replace("table", _i.gfm.table)
        .replace("blockquote", " {0,3}>")
        .replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n")
        .replace("list", " {0,3}(?:[*+-]|1[.)]) ")
        .replace(
      ...
      (_i.pedantic = mi({}, _i.normal, {
        ...
        heading: /^(#{1,6})(.*)(?:\n+|$)/,
        fences: pi,
        paragraph: si(_i.normal._paragraph)
          .replace("hr", _i.hr)
          .replace("heading", " *#{1,6} *[^\n]")
          .replace("lheading", _i.lheading)
          .replace("blockquote", " {0,3}>")
          .replace("|fences", "")
          .replace("|list", "")
          .replace("|html", "")
    ...
    ($i._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
      ($i.punctuation = si($i.punctuation)
        .replace(/punctuation/g, $i._punctuation)
        .getRegex()),
      ($i.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
      ($i.escapedEmSt = /\\\*|\\_/g),
      ($i._comment = si(_i._comment)
        .replace("(?:--\x3e|$)", "--\x3e")
        .getRegex()),
      ($i.emStrong.lDelim = si($i.emStrong.lDelim)
        .replace(/punct/g, $i._punctuation)
        .getRegex()),
      ($i.emStrong.rDelimAst = si($i.emStrong.rDelimAst, "g")
        .replace(/punct/g, $i._punctuation)
        .getRegex()),
      ($i.emStrong.rDelimUnd = si($i.emStrong.rDelimUnd, "g")
        .replace(/punct/g, $i._punctuation)
        .getRegex()),
      ($i._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
      ...
      ($i.link = si($i.link)
        ...
        .getRegex()),
      ($i.reflink = si($i.reflink)
        .replace("label", $i._label)
        .replace("ref", _i._label)
        .getRegex()),
      ($i.nolink = si($i.nolink).replace("ref", _i._label).getRegex()),
      ($i.reflinkSearch = si($i.reflinkSearch, "g")
        .replace("reflink", $i.reflink)
        .replace("nolink", $i.nolink)
        .getRegex()),
      ($i.normal = mi({}, $i)),
      ($i.pedantic = mi({}, $i.normal, {
        strong: {
          start: /^__|\*\*/,
          middle:
      ...
      ($i.gfm = mi({}, $i.normal, {
        escape: si($i.escape).replace("])", "~|])").getRegex(),
        _extended_email:
      ...
      ($i.gfm.url = si($i.gfm.url, "i")
        .replace("email", $i.gfm._extended_email)
        .getRegex()),
      ($i.breaks = mi({}, $i.gfm, {
        br: si($i.br).replace("{2,}", "*").getRegex(),
        text: si($i.gfm.text)
          .replace("\\b_", "\\b_| {2,}\\n")
          .replace(/\{2,\}/g, "*")
          .getRegex(),
    ...
    class Ci {
      constructor(e) {
        ...
        const t = { block: _i.normal, inline: $i.normal };
        this.options.pedantic
          ? ((t.block = _i.pedantic), (t.inline = $i.pedantic))
          : this.options.gfm &&
            ((t.block = _i.gfm),
      ...
      static get rules() {
        return { block: _i, inline: $i };
      }
      static lex(e, t) {
        return new Ci(t).lex(e);
      }
      static lexInline(e, t) {
        return new Ci(t).inlineTokens(e);
      }
      lex(e) {
        let t;
        for (
        ...
        for (this.options.pedantic && (e = e.replace(/^ +$/gm, "")); e; )
          if (
            ...
            if ((i = this.tokenizer.space(e)))
              ...
              (e = e.substring(i.raw.length)),
                (a = t[t.length - 1]),
                !a || ("paragraph" !== a.type && "text" !== a.type)
                  ? t.push(i)
                  : ((a.raw += "\n" + i.raw),
                    (a.text += "\n" + i.text),
              ...
              if (
                ...
                this.options.extensions.startBlock.forEach(function (e) {
                  (a = e.call({ lexer: this }, i)),
                    "number" == typeof a && a >= 0 && (t = Math.min(t, a));
                }),
            ...
            if ((i = this.tokenizer.escape(e)))
              ...
              (e = e.substring(i.raw.length)),
                ...
                a && "text" === i.type && "text" === a.type
                  ? ((a.raw += i.raw), (a.text += i.text))
                  : t.push(i);
            else if ((i = this.tokenizer.emStrong(e, l, s)))
              (e = e.substring(i.raw.length)), t.push(i);
              ...
              (e = e.substring(i.raw.length)), t.push(i);
            else if ((i = this.tokenizer.autolink(e, zi)))
              (e = e.substring(i.raw.length)), t.push(i);
            else if (this.state.inLink || !(i = this.tokenizer.url(e, zi))) {
              if (
                ((r = e),
              ...
              if ((i = this.tokenizer.inlineText(r, Si)))
                (e = e.substring(i.raw.length)),
    ...
    class Ai {
      ...
      code(e, t, i) {
        ...
        if (this.options.highlight) {
          const t = this.options.highlight(e, a);
          null != t && t !== e && ((i = !0), (e = t));
        }
        return (
          (e = e.replace(/\n$/, "") + "\n"),
      ...
      link(e, t, i) {
        if (null === (e = di(this.options.sanitize, this.options.baseUrl, e)))
          return i;
        let a = '<a href="' + ai(e) + '"';
    ...
    class Ei {
      ...
      getNextSafeSlug(e, t) {
        ...
        return t || ((this.seen[e] = a), (this.seen[i] = 0)), i;
      }
      slug(e, t = {}) {
        ...
        for (i = 0; i < y; i++)
          if (
            ...
            this.options.extensions &&
              ...
              ((x = this.options.extensions.renderers[h.type].call(
                { parser: this },
                h
              )),
              !1 !== x ||
            ...
            switch (h.type) {
              ...
              case "heading":
                k += this.renderer.heading(
                  ...
                  h.depth,
                  oi(this.parseInline(h.tokens, this.textRenderer)),
                  this.slugger
                );
                continue;
              case "code":
                ...
                continue;
              case "table":
                for (c = "", l = "", o = h.header.length, a = 0; a < o; a++)
                ...
                for (
                  ...
                  for (s = h.rows[a], l = "", n = s.length, r = 0; r < n; r++)
                    l += this.renderer.tablecell(
                ...
                continue;
              case "blockquote":
                (d = this.parse(h.tokens)), (k += this.renderer.blockquote(d));
                continue;
              case "list":
                for (
                  f = h.ordered,
                  ...
                  (m = h.items[a]),
                    ...
                    m.task &&
                      ...
                      u
                        ...
                        : (p += w)),
                    (p += this.parse(m.tokens, u)),
                    (d += this.renderer.listitem(p, v, g));
                k += this.renderer.list(d, f, b);
                continue;
              case "html":
                k += this.renderer.html(h.text);
                continue;
              case "paragraph":
                k += this.renderer.paragraph(this.parseInline(h.tokens));
                continue;
              case "text":
                for (
                  d = h.tokens ? this.parseInline(h.tokens) : h.text;
                  i + 1 < y && "text" === e[i + 1].type;
          ...
          if (
            ...
            switch (a.type) {
              ...
              case "html":
                ...
                break;
              case "link":
                o += t.link(a.href, a.title, this.parseInline(a.tokens, t));
                break;
              case "image":
                o += t.image(a.href, a.title, a.text);
                break;
              case "strong":
                o += t.strong(this.parseInline(a.tokens, t));
                break;
              case "em":
                o += t.em(this.parseInline(a.tokens, t));
                break;
              case "codespan":
                o += t.codespan(a.text);
                break;
              case "br":
                ...
                break;
              case "del":
                o += t.del(this.parseInline(a.tokens, t));
                break;
              case "text":
                o += t.text(a.text);
                break;
    ...
    function Li(e, t, i) {
      ...
      if (
        ...
        const o = function (e) {
          ...
          if (!e)
            try {
              t.walkTokens && Li.walkTokens(r, t.walkTokens),
                (o = Ii.parse(r, t));
            } catch (t) {
              e = t;
            }
          return (t.highlight = a), e ? i(e) : i(null, o);
        };
        if (!a || a.length < 3) return o();
        if ((delete t.highlight, !r.length)) return o();
        let n = 0;
        return (
          Li.walkTokens(r, function (e) {
            "code" === e.type &&
              (n++,
              setTimeout(() => {
                a(e.text, e.lang, function (t, i) {
                  if (t) return o(t);
      ...
      try {
        const i = Ci.lex(e, t);
        return t.walkTokens && Li.walkTokens(i, t.walkTokens), Ii.parse(i, t);
      } catch (e) {
        if (
          ((e.message +=
          ...
          return (
            "<p>An error occurred:</p><pre>" + ai(e.message + "", !0) + "</pre>"
          );
        throw e;
      }
    }
    (Li.options = Li.setOptions =
      function (e) {
        var t;
        return mi(Li.defaults, e), (t = Li.defaults), (Qt = t), Li;
      }),
      (Li.getDefaults = Zt),
      (Li.defaults = Qt),
      (Li.use = function (...e) {
        const t = mi({}, ...e),
          i = Li.defaults.extensions || { renderers: {}, childTokens: {} };
        let a;
        e.forEach((e) => {
          if (
            (e.extensions &&
            ...
            const i = Li.defaults.renderer || new Ai();
            for (const t in e.renderer) {
              const a = i[t];
              i[t] = (...r) => {
                let o = e.renderer[t].apply(i, r);
                return !1 === o && (o = a.apply(i, r)), o;
              };
            }
            t.renderer = i;
          }
          if (e.tokenizer) {
            const i = Li.defaults.tokenizer || new yi();
            for (const t in e.tokenizer) {
              const a = i[t];
              i[t] = (...r) => {
                let o = e.tokenizer[t].apply(i, r);
                return !1 === o && (o = a.apply(i, r)), o;
              };
            }
            t.tokenizer = i;
          ...
          if (e.walkTokens) {
            const i = Li.defaults.walkTokens;
            t.walkTokens = function (t) {
              e.walkTokens.call(this, t), i && i.call(this, t);
            };
          }
          a && (t.extensions = i), Li.setOptions(t);
        });
      }),
      (Li.walkTokens = function (e, t) {
        for (const i of e)
          switch ((t.call(Li, i), i.type)) {
            case "table":
              for (const e of i.header) Li.walkTokens(e.tokens, t);
              for (const e of i.rows)
                for (const i of e) Li.walkTokens(i.tokens, t);
              break;
            case "list":
              Li.walkTokens(i.items, t);
              break;
            default:
              Li.defaults.extensions &&
              Li.defaults.extensions.childTokens &&
              Li.defaults.extensions.childTokens[i.type]
                ? Li.defaults.extensions.childTokens[i.type].forEach(function (
                    e
                  ) {
                    Li.walkTokens(i[e], t);
                  })
                : i.tokens && Li.walkTokens(i.tokens, t);
          }
      }),
      (Li.parseInline = function (e, t) {
        if (null == e)
          throw new Error(
        ...
        wi((t = mi({}, Li.defaults, t || {})));
        try {
          const i = Ci.lexInline(e, t);
          return (
            t.walkTokens && Li.walkTokens(i, t.walkTokens), Ii.parseInline(i, t)
          );
        } catch (e) {
          if (
            ((e.message +=
    ...
    class Ti extends X {
      ...
      recalcSplitter(e) {
        this.splitDirection =
          this.isSidebar || e < 769 ? "vertical" : "horizontal";
      }
      firstUpdated() {
        this.recalcSplitter(document.documentElement.clientWidth),
          (this.obs = new ResizeObserver((e) => {
            this.recalcSplitter(e[0].contentRect.width);
          })),
          this.obs.observe(this);
      }
      updated(e) {
        e.has("collInfo") && this.doLoadCurated(),
          (e.has("collInfo") || e.has("isSidebar")) &&
            this.recalcSplitter(document.documentElement.clientWidth),
          e.has("splitDirection") && this.configureSplitter(),
          e.has("currList") &&
            this.active &&
            this.sendChangeEvent({ currList: this.currList });
      }
      configureSplitter() {
        const e = this.renderRoot.querySelector(".sidebar"),
          t = this.renderRoot.querySelector(".main-content");
        if (this.splitter) {
          try {
            this.splitter.destroy();
          } catch (e) {}
      ...
      async doLoadCurated() {
        this.curatedPageMap = {};
        const e = {};
        for (const t of this.collInfo.pages) e[t.id] = t;
        for (const e of this.collInfo.curatedPages) {
          this.curatedPageMap[e.list] || (this.curatedPageMap[e.list] = []);
          const t = e,
            i = t.url,
            a = t.ts,
            r = t.title || t.url,
            o = e.desc;
          this.curatedPageMap[e.list].push({
            url: i,
            ts: a,
            title: r,
            desc: o,
    ...
    ${e} .menu {
      ...
      render() {
        const e = this.currList;
        return P`
    <div class="is-sr-only" role="heading" aria-level="${
      this.isSidebar ? "2" : "1"
    }">
    ...
    <div class="columns">
      <div class="column sidebar is-one-fifth">
        <aside class="menu">
          <ul class="menu-list">
            <li>
              <a href="#list-0" data-list="0" class="${
                0 === e ? "is-active" : ""
              } menu-label is-size-4"
                @click=${this.onClickScroll}>${this.collInfo.title}</a>
              <ul class="menu-list">${this.collInfo.lists.map(
                (t) => P`
                <li>
  ...
  `;
    ...
    <article id="list-${e.id}">
      <div class="content">
        ...
        <ol>
          ${
            this.curatedPageMap[e.id]
              ? this.curatedPageMap[e.id].map((e) => this.renderCPage(e))
              : P``
          }
        </ol>
      </div>
    ...
    <li>
      ...
      onReplay(e) {
        ...
        const t = {
          ...
          ts: e.currentTarget.getAttribute("data-ts"),
        };
        return this.sendChangeEvent(t), !1;
      }
      sendChangeEvent(e) {
        this.dispatchEvent(
          new CustomEvent("coll-tab-nav", { detail: { data: e } })
        );
      }
      onClickScroll(e) {
        return (
          e.preventDefault(),
          (this.currList = Number(e.currentTarget.getAttribute("data-list"))),
          this.scrollToList(),
          !1
        );
      }
      scrollToList() {
        this.currList > this.collInfo.lists.length && (this.currList = 0);
        const e = { behavior: "smooth", block: "nearest", inline: "nearest" };
        this.clickTime = new Date().getTime();
        const t = this.renderRoot.getElementById("list-" + this.currList);
        t && t.scrollIntoView(e);
      }
      onScroll(e) {
        const t = e.currentTarget,
          i = this.renderRoot.getElementById("list-" + this.currList);
        if (!i) return;
        let a = i;
        const r = t.offsetTop,
          o = t.scrollTop;
        if (o > this.lastST)
          for (
            ...
            a.nextElementSibling.getBoundingClientRect().top < r;
          ...
          for (
            ...
            a.previousElementSibling.getBoundingClientRect().bottom >= r;
        ...
        if (
          ...
          a &&
            a != i &&
            a.id.startsWith("list-") &&
            (this.currList = Number(a.id.slice(5))),
          new Date().getTime() - this.clickTime < 1e3)
        )
          return;
    ...
    customElements.define("wr-coll-story", Ti);
    var Pi = __webpack_require__(4199),
      Ui = __webpack_require__.n(Pi);
    class Ri extends X {
      constructor() {
        super(),
      ...
      updated(e) {
        e.has("sourceUrl") &&
          ((this.error = !1),
          (this.state = "trypublic"),
          this.tryPublicAccess().then((e) => {
            e || ((this.state = "tryauto"), this.requestUpdate());
          }));
      }
      async tryPublicAccess() {
        try {
          const e = this.sourceUrl,
            t = `https://helper-proxy.webrecorder.workers.dev/g/${e.slice(
              "googledrive://".length
            )}`;
          let i = null;
          try {
          ...
          if (!a.url || !a.name || !a.size) return !1;
          if (a.size > 15e6) return !1;
          const r = a.url;
          try {
            const e = new AbortController(),
              t = e.signal;
            if (
              ((i = await fetch(r, { signal: t })), e.abort(), 200 != i.status)
            )
              return !1;
          } catch (e) {
            return !1;
          ...
          return (
            this.dispatchEvent(
              new CustomEvent("load-ready", {
                detail: { name: o, extra: n, size: s, sourceUrl: e },
              })
            ),
            !0
          );
      ...
      onLoad() {
        (this.scriptLoaded = !0),
          this.gauth("none", (e) => {
            e.error
              ? "implicitonly" !== this.state && (this.state = "trymanual")
              : this.authed(e);
          });
      }
      onClickAuth() {
        this.gauth("select_account", (e) => {
          e.error || this.authed(e);
        });
      }
      async authed(e) {
        const t = this.sourceUrl,
          i = `https://www.googleapis.com/drive/v3/files/${t.slice(
            "googledrive://".length
          )}`,
          a = { Authorization: `Bearer ${e.access_token}` },
          r = await fetch(i + "?fields=name,size&supportsAllDrives=true", {
            headers: a,
          });
        if (404 === r.status || 403 == r.status)
          return (
            "implicitonly" !== this.state && (this.state = "trymanual"),
            void (this.error = !0)
          );
        ...
        this.dispatchEvent(
          new CustomEvent("load-ready", {
            detail: { sourceUrl: t, headers: a, size: s, name: n },
          })
        );
      }
      static get styles() {
    ...
    `
      ...
      script() {
        if ("trypublic" === this.state || this.scriptLoaded) return P``;
    ...
    customElements.define("wr-gdrive", Ri);
    class qi extends X {
      constructor() {
        super(),
          (this.progress = 0),
      ...
      initMessages() {
        ...
        } else this.worker = new Worker("sw.js");
        this.worker.addEventListener("message", (e) => {
          switch (e.data.msg_type) {
            case "collProgress":
              if (e.data.name === this.coll) {
                if (((this.percent = e.data.percent), e.data.error))
                  if (
                    ((this.error = e.data.error),
                    (this.state = "errored"),
                    (this.errorAllowRetry = !0),
                    (this.fileHandle = e.data.fileHandle),
                    "missing_local_file" === this.error)
                  )
                    this.tryFileHandle = !1;
                  else if (
                    "permission_needed" === this.error &&
                    e.data.fileHandle
                  ) {
                ...
                e.data.currentSize &&
                  e.data.totalSize &&
                  ((this.currentSize = e.data.currentSize),
                  (this.totalSize = e.data.totalSize)),
                  (this.extraMsg = e.data.extraMsg);
              }
              break;
            case "collAdded":
              e.data.name === this.coll &&
                (this.total || (this.total = 100),
                (this.progress = this.total),
                (this.percent = 100),
                this.dispatchEvent(
                  new CustomEvent("coll-loaded", { detail: e.data })
                ),
                this.noWebWorker
      ...
      async doLoad() {
        ...
        if (
          ...
          this.loadInfo && this.loadInfo.swError)
        )
          return (
            (this.state = "errored"),
            (this.error = this.loadInfo.swError),
            void (this.errorAllowRetry = !1)
          );
        try {
          const {
            scheme: e,
            ...
            return (
              ...
              (i = e.indexOf("/", t)),
              i > 0
                ? ((r = e.slice(t, i)), (o = e.slice(i)))
                : ((r = e.slice(t)), (o = "")),
              { scheme: a, host: r, path: o }
            );
          })(i);
          switch (e) {
            case "googledrive":
              (this.state = "googledrive"), (a = await this.googledriveInit());
              break;
            case "s3":
              a = {
                sourceUrl: i,
                loadUrl: `https://${t}.s3.amazonaws.com${r}`,
                name: this.sourceUrl,
              };
              break;
            case "file":
        ...
        a || (a = { sourceUrl: i }),
          (this.state = "started"),
          this.loadInfo &&
            ((a.newFullImport = this.loadInfo.newFullImport),
            (a.loadEager = this.loadInfo.loadEager),
            (a.noCache = this.loadInfo.noCache),
            this.loadInfo.extraConfig && (t = this.loadInfo.extraConfig),
            i.startsWith("proxy:") &&
              t &&
              t.recording &&
              (e = "recordingproxy"));
      ...
      googledriveInit() {
        return (
          (this._gdWait = new Promise((e) => (this._gdResolve = e))),
          this._gdWait
        );
      }
      async onLoadReady(e) {
        this._gdResolve && this._gdResolve(e.detail);
      }
      onCancel() {
        if (!this.worker) return;
        const e = { msg_type: "cancelLoad", name: this.coll };
        this.noWebWorker
          ? navigator.serviceWorker &&
            navigator.serviceWorker.controller &&
      ...
      updated(e) {
        ((this.sourceUrl && e.has("sourceUrl")) || e.has("tryFileHandle")) &&
          this.doLoad();
      }
      static get styles() {
        return ue(o`
    ...
    `;
      ...
      renderContent() {
        switch (this.state) {
          case "googledrive":
            return P`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;
          case "started":
            return P`
          <div class="progress-div">
            ...
            ${
              this.currentSize && this.totalSize
                ? P`
              <div class="loaded-prog">Loaded <b>${Re()(
                this.currentSize
              )}</b> of <b>${Re()(this.totalSize)}</b>
              ${
                this.extraMsg &&
                P`
          ...
          ${
            this.errorAllowRetry
              ? P`
          <a class="button is-warning" @click=${() =>
            window.parent.location.reload()}>Try Again</a>`
              : ""
          }
          ${
            this.embed
        ...
        <div class="has-text-left">
          ...
          default:
            return P`<progress class="progress is-primary is-large" style="max-width: 400px"/>`;
        }
      }
    ...
    customElements.define("wr-loader", qi);
    var Mi = __webpack_require__(9746),
      ji = __webpack_require__.n(Mi),
      Bi = __webpack_require__(6304),
      Hi = __webpack_require__(6442),
      Oi = __webpack_require__.n(Hi),
      Ni = __webpack_require__(9638),
      Fi = __webpack_require__.n(Ni);
    class Wi extends X {
      constructor() {
        super(),
          (this.filteredPages = []),
      ...
      _timedUpdate() {
        null !== this.newQuery &&
          ((this.query = this.newQuery), (this.newQuery = null), this.filter());
      }
      async updated(e) {
        if (
          (e.has("collInfo")
            ? this.updateTextSearch()
            : (e.has("query") || e.has("currList")) && this.filter(),
          e.has("active") && this.active && this.changeNeeded && this.filter(),
          e.has("query"))
        ) {
          this.query
            ? ((this.sortKey = ""), (this.sortDesc = !1))
            : ((this.sortKey = "date"), (this.sortDesc = !0));
          const e = this.renderRoot.querySelector("wr-sorter");
          e && ((e.sortKey = this.sortKey), (e.sortDesc = this.sortDesc));
        }
        if (e.has("sortedPages") && this.isSidebar) {
          const e = this.renderRoot.querySelector(".current");
          if (e) {
            const t = {
              behavior: "smooth",
              block: "nearest",
            ...
            setTimeout(() => e.scrollIntoView(t), 100);
          }
        }
      }
      onChangeQuery(e) {
        (this.newQuery = e.currentTarget.value),
          this._ival && window.clearTimeout(this._ival),
          (this._ival = window.setTimeout(() => this._timedUpdate(), 250));
      }
      async filter() {
        if (this.loading) return;
        if (
          (this.active || (this.changeNeeded = !0),
          (this.loading = !0),
          this.flex && this.query && this.textPages)
        ) {
          const e = await this.flex.searchAsync(this.query, 25);
          this.filteredPages = e.map((e) => this.textPages[e]);
        } else this.filteredPages = [...this.collInfo.pages];
        0 !== this.currList && (await this.filterCurated());
        for (const e of this.filteredPages) {
          const { timestamp: t, date: i } = Ve(e);
          (e.timestamp = t), (e.date = i);
        }
        (this.loading = !1), (this.changeNeeded = !1);
        const e = { query: this.query, currList: this.currList };
        this.sendChangeEvent(e);
      }
      async filterCurated() {
        const e = await fetch(
            `${this.collInfo.apiPrefix}/curated/${this.currList}`
          ),
          t = (await e.json()).curated;
        this.filteredPages = t;
      }
      sendChangeEvent(e) {
        this.dispatchEvent(
          new CustomEvent("coll-tab-nav", { detail: { data: e } })
      ...
      async updateTextSearch() {
        if (this.updatingSearch) return;
        this.updatingSearch = !0;
        let e = 0;
        try {
          const t = await caches.open("cache:" + this.collInfo.coll),
            i = `${this.collInfo.apiPrefix}/textIndex`;
          let a = await t.match(i);
          (a && Number(a.headers.get("Content-Length"))) ||
            ((a = await fetch(`${this.collInfo.apiPrefix}/textIndex`)),
            200 === a.status &&
              Number(a.headers.get("Content-Length")) &&
              t.put(i, a.clone()));
          const r = [];
          for await (const t of ji()(a.body.getReader()))
            t.text && ((t.id = ++e), r.push(t));
          await this.addPages(r);
        } catch (e) {
          console.warn(e);
        } finally {
          0 === e && (await this.addPages(this.collInfo.pages)),
            (this.updatingSearch = !1);
        }
        await this.filter();
      }
    ...
    ${e} .menu {
      ...
      onSelectListDrop(e) {
        e.preventDefault(), (this.currList = Number(e.currentTarget.value));
      }
      render() {
        const e = this.currList;
        return P`
    ...
    <div class="search-bar notification is-marginless">
      ${
        this.isSidebar
          ? P`<h3 class="is-sr-only">Search and Filter Pages</h3>`
          : ""
      }
      <div class="field flex-auto">
        <div class="control has-icons-left ${this.loading ? "is-loading" : ""}">
          <input type="search" class="input" @input="${
            this.onChangeQuery
          }" .value="${this.query}" type="text"
    ...
    <div class="main columns">
      <div class="column index-bar is-one-fifth is-hidden-mobile">
        ...
        `
            : P`
        <div class="index-bar-title" @dblclick="${() => (this.editing = !0)}">${
                this.collInfo.title
              }</div>`
        }
        ...
        ${
          this.editable
            ? P`<fa-icon class="editIcon" .svg="${Fi()}"></fa-icon>`
            : P``
        }
        ...
        <div class="dropdown-menu" id="dropdown-menu">
          <div class="dropdown-content">
            <a role="button" href="#"
             ...
             class="dropdown-item">
              Download ${
                0 === this.selectedPages.size ? "All" : "Selected"
    ...
    <div class="header columns is-hidden-mobile">
      ...
      <a role="button" href="#" @click="${
        this.onSort
      }" @keyup="${ge}" data-key="" class="column is-1 ${
              "" === this.sortKey ? (this.sortDesc ? "desc" : "asc") : ""
            }">Match</a>`
          : ""
      }
      ...
      <a role="button" href="#" @click="${
        this.onSort
      }" @keyup="${ge}" data-key="date" class="column is-2 ${
          "date" === this.sortKey ? (this.sortDesc ? "desc" : "asc") : ""
        }">Date</a>
      <a role="button" href="#" @click="${
        this.onSort
      }" @keyup="${ge}" data-key="title" class="column is-6 pagetitle ${
          "title" === this.sortKey ? (this.sortDesc ? "desc" : "asc") : ""
        }">Page Title</a>
    </div>
    ...
    `;
      ...
      renderDeleteModal() {
        return this.toDeletePages
          ? P`
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${() =>
      (this.toDeletePages = this.toDeletePage = null)}" title="Confirm Delete">
      ${
        this.toDeletePage
          ? P`
      <p>Are you sure you want to delete the page <b>${
        this.toDeletePage.title
      }</b>?
      (Size: <b>${Re()(this.toDeletePage.size)}</b>)</p>`
          : P`
      ...
      <button @click="${() =>
        (this.toDeletePages = this.toDeletePage =
          null)}" class="button">Cancel</button>
    </wr-modal>`
          : P``;
      }
      isCurrPage(e) {
        if (this.isSidebar && e.url === this.url) {
          let t = e.timestamp;
          return (
            !t && e.date
              ? (t = Ze(e.date))
              : "string" == typeof e.ts && (t = Ze(e.ts)),
            t === this.ts
          );
        }
        return !1;
      ...
      <ul class="scroller" @scroll="${this.onScroll}">
        ${
          this.sortedPages.length
            ? P`
          ${this.sortedPages.map((e, t) => {
            const i = this.selectedPages.has(e.id);
            return P`
          <li class="page-entry ${i ? "selected" : ""}">
            ...
            : P`<p class="mobile-header">${this.getNoResultsMessage()}</p>`
        }
      </ul>
    `;
      }
      onUpdateTitle(e) {
        if ((e.preventDefault(), (this.editing = !1), !this.editable)) return;
        const t = this.renderRoot.querySelector("#titleEdit");
        ...
        fetch(`${this.collInfo.apiPrefix}/metadata`, {
          ...
          200 === e.status &&
            this.dispatchEvent(
              new CustomEvent("coll-update", { detail: { title: i } })
            );
        });
      }
      onMenu(e) {
      ...
      onSort(e) {
        e.preventDefault();
        const t = e.currentTarget.getAttribute("data-key") || "";
        t === this.sortKey
          ? (this.sortDesc = !this.sortDesc)
          : ((this.sortDesc = !1), (this.sortKey = t));
      }
      onSortChanged(e) {
        (this.sortedPages = e.detail.sortedData),
          (this.sortKey = e.detail.sortKey),
          (this.sortDesc = e.detail.sortDesc);
      }
      onSelectToggle(e) {
        const { page: t, selected: i } = e.detail;
        i ? this.selectedPages.add(t) : this.selectedPages.delete(t),
          (this.allSelected =
            this.selectedPages.size === this.sortedPages.length),
          this.requestUpdate();
      }
      onSelectAll(e) {
        (this.allSelected = e.currentTarget.checked),
          this.allSelected
            ? this.sortedPages.forEach((e) => {
                this.selectedPages.add(e.id);
              })
            : this.selectedPages.clear(),
          this.requestUpdate();
      }
      async onDownload(e, t) {
        e.preventDefault();
        const i = this.selectedPages.size > 0,
          a = new URLSearchParams();
        a.set(
          "pages",
          i ? Array.from(this.selectedPages.keys()).join(",") : "all"
        ),
          a.set("format", t),
          this.collInfo.filename && a.set("filename", this.collInfo.filename),
          (window.location.href =
            `${this.collInfo.apiPrefix}/dl?` + a.toString());
      }
      onDeleteConfirm(e) {
        const t = e.currentTarget.page;
        this.selectedPages.has(t.id)
          ? ((this.toDeletePages = this.selectedPages),
            (this.toDeletePage = null))
          : ((this.toDeletePages = [t.id]), (this.toDeletePage = t));
      }
      async onDeletePages() {
        const e = {};
        for (const t of this.toDeletePages) {
          const i = this.renderRoot.querySelector(`wr-page-entry[pid="${t}"]`);
          i && ((i.deleting = !0), (e[t] = i));
        }
        for (const t of this.toDeletePages) {
          const i = await fetch(`${this.collInfo.apiPrefix}/page/${t}`, {
              method: "DELETE",
            }),
            a = await i.json();
          if (a.error) {
          ...
          const r = e[t];
          if (!r) continue;
          const o = this.collInfo.pages.indexOf(r);
          o < 0 || this.collInfo.pages.splice(o, 1);
        }
        (this.toDeletePages = null),
          (this.toDeletePage = null),
          this.updateTextSearch(),
      ...
      formatResults() {
        return 1 === this.sortedPages.length
          ? "1 Page Found"
          : `${this.sortedPages.length} Pages Found`;
      }
      getNoResultsMessage() {
        return this.collInfo && this.collInfo.pages.length
          ? this.updatingSearch
            ? "Initializing Search..."
            : this.loading
            ? "Searching..."
            : this.query
            ? P`<span class="fix-text-wrapping">No matching pages found. Try changing the search query, or <a href="#view=resources">browse by URL</a>.</span>`
            : "No Pages Found"
          : P`<span class="fix-text-wrapping">No Pages are defined in this archive. The archive may be empty. <a href="#view=resources">Try browsing by URL</a>.</span>`;
      }
      onScroll(e) {
        const t = e.currentTarget;
    ...
    customElements.define("wr-page-view", Wi);
    const Gi = new RegExp(
        `[${[
          "-",
          "[",
    ...
    class Vi extends HTMLElement {
      ...
      get keywords() {
        var e;
        return null !== (e = this.getAttribute("keywords")) && void 0 !== e
          ? e
          : "";
      }
      set keywords(e) {
        this.setAttribute("keywords", e);
      }
      get delimiter() {
        var e;
        return null !== (e = this.getAttribute("delimiter")) && void 0 !== e
          ? e
          : "";
      }
      set delimiter(e) {
        this.setAttribute("delimiter", e);
      }
      attributeChangedCallback(e, t, i) {
        ("keywords" !== e && "delimiter" !== e) || (i !== t && this._render());
      }
      connectedCallback() {
        this._render(),
      ...
      disconnectedCallback() {
        this.__observer &&
          (this.__observer.disconnect(), (this.__observer = void 0));
      }
      _render() {
        if (!this.shadowRoot) return;
        const e = this.textContent || "",
          t = this.getAttribute("keywords"),
          i = this.getAttribute("delimiter") || /\s+/;
        if (!t) return void (this.shadowRoot.textContent = e);
        const a = e.toLowerCase(),
          r = t
            .toLowerCase()
            .split(i)
            .sort((e, t) => t.length - e.length),
          o = new RegExp(`${r.map(Ki).join("|")}`, "gi"),
          n = e.split(o),
        ...
        for (const t of n)
          if (
            ...
            const t = a.substring(l),
              i = r.find((e) => t.startsWith(e));
            if (i) {
              const t = document.createElement("mark");
              (t.textContent = e.substr(l, i.length)),
                s.appendChild(t),
                (l += i.length);
            }
          }
    ...
    customElements.define("keyword-mark", Vi);
    class Zi extends X {
      constructor() {
        super(),
          (this.query = ""),
    ...
    `;
      ...
      render() {
        const e = this.page,
          t = this.page.date,
          i = "number" == typeof e.size,
          a = this.editable && !this.isSidebar;
        return P`
    ${
      a
        ? P`
        ...
        <div class="media">
          <figure class="media-left">
            ...
            ${
              this.iconValid
                ? P`
              <img class="favicon" @error="${() =>
                (this.iconValid = !1)}" src="${this.replayPrefix}/${
                    this.page.timestamp
                  }id_/${e.favIconUrl}"/>`
                : P`
          ...
          <div class="media-content ${this.isCurrent ? "current" : ""}">
            <div role="heading" aria-level="${this.isSidebar ? "4" : "3"}">
              <a @dblclick="${this.onReload}" @click="${
          this.onReplay
          ...
          e.title || e.url
              ...
              <p class="has-text-dark text"><keyword-mark keywords="${
                this.query
              }">${e.url}</keyword-mark></p>
    ...
    `;
      ...
      async updateFavIcon() {
        if (!this.page.favIconUrl) return void (this.favIconData = null);
        const e = await fetch(
          `${this.replayPrefix}/${this.page.timestamp}id_/${this.page.favIconUrl}`
        );
        if (200 != e.status) return void (this.favIconData = null);
        const t = await e.arrayBuffer(),
          i = e.headers.get("content-type");
        try {
          this.favIconData = `data:${i};base64,${btoa(
            String.fromCharCode.apply(null, t)
          )}`;
        } catch (e) {
          console.log(e), (this.favIconData = null);
        }
      }
      updateSnippet() {
        const e = this.textSnippet;
        if (!this.query || !this.page.text)
          return (
            (this.textSnippet = null), void this.requestUpdate("textSnippet", e)
          );
        let t = this.page.text,
          i = this.query,
          a = t.indexOf(this.query);
        if (a < 0) {
          let r = t.toLowerCase(),
            o = i.toLowerCase();
          if (((a = r.indexOf(o)), a < 0))
            return (
              (this.textSnippet = null),
              void this.requestUpdate("textSnippet", e)
            );
          (t = r), (i = o);
        }
        let r = a;
        (a = Math.max(a - 100, 0)),
          (r = Math.min(r + 200, t.length)),
          0 === a && r === t.length
            ? (this.textSnippet = t)
            : (this.textSnippet = "..." + t.slice(a, r) + "..."),
          this.requestUpdate("textSnippet", e);
      }
      onReplay(e, t = !1) {
        e.preventDefault();
        const i = { url: this.page.url, ts: this.page.timestamp };
        return this.sendChangeEvent(i, t), !1;
      }
      onReload(e) {
        return this.onReplay(e, !0);
      }
      sendChangeEvent(e, t) {
        this.dispatchEvent(
      ...
      onSendDeletePage() {
        const e = this.page;
        this.dispatchEvent(
          new CustomEvent("delete-page", { detail: { page: e } })
        );
      }
      onSendSelToggle(e) {
        ...
        this.dispatchEvent(
          new CustomEvent("sel-page", { detail: { page: t, selected: i } })
        );
      }
    }
    customElements.define("wr-page-entry", Zi);
    class Qi extends X {
      constructor() {
        super(),
          (this.replayUrl = ""),
      ...
      firstUpdated() {
        window.addEventListener("message", (e) => this.onReplayMessage(e)),
          navigator.serviceWorker.addEventListener("message", (e) =>
            this.handleAuthMessage(e)
          );
      }
      async handleAuthMessage(e) {
        if (
          "authneeded" === e.data.type &&
          this.collInfo &&
          e.data.coll === this.collInfo.coll
        ) {
          if (e.data.fileHandle) {
            this.authFileHandle = e.data.fileHandle;
            try {
              if (
                "granted" ===
          ...
          } else this.authFileHandle = null;
          this.reauthWait ? await this.reauthWait : (this.showAuth = !0);
        }
      }
      doSetIframeUrl() {
      ...
      updated(e) {
        if (
          ((e.has("sourceUrl") || e.has("collInfo")) &&
            (this.reauthWait = null),
          !this.url ||
            ...
            (this.reauthWait = null),
            this.doSetIframeUrl()),
          this.iframeUrl && e.has("iframeUrl"))
        ) {
          this.waitForLoad();
          const e = { title: "Archived Page", replayTitle: !1 };
          this.dispatchEvent(
            new CustomEvent("update-title", {
              bubbles: !0,
              composed: !0,
        ...
        if (
          (this.replayUrl && e.has("replayUrl")) ||
          (this.replayTS && e.has("replayTS"))
        ) {
          const e = { url: this.replayUrl, ts: this.replayTS };
          this.dispatchEvent(
            new CustomEvent("coll-tab-nav", {
              detail: { replaceLoc: !0, data: e },
            })
          );
        }
        if (this.title && (e.has("title") || e.has("actualTS"))) {
          const e = {
            title: this.title,
            url: this.replayUrl,
            ts: this.actualTS,
      ...
      setDisablePointer(e) {
        const t = this.renderRoot.querySelector("iframe");
        t && (t.style.pointerEvents = e ? "none" : "all");
      }
      onReplayMessage(e) {
        const t = this.renderRoot.querySelector("iframe");
        if (t && e.source === t.contentWindow)
          if ("load" === e.data.wb_type || "replace-url" === e.data.wb_type) {
            if (
              ((this.replayTS = e.data.is_live ? "" : e.data.ts),
              (this.actualTS = e.data.ts),
              (this.replayUrl = e.data.url),
              (this.title = e.data.title || this.title),
              this.clearLoading(t.contentWindow),
              e.data.icons)
            ) {
              const t = e.data.icons;
              this.dispatchEvent(
          ...
          } else "title" === e.data.wb_type && (this.title = e.data.title);
      }
      onReAuthed(e) {
        this.reauthWait = (async () => {
          if (this.authFileHandle) {
            if (
              ...
              return void (this.reauthWait = null);
            this.authFileHandle = null;
          } else {
            const t = e.detail.headers;
            await fetch(`${this.collInfo.apiPrefix}/updateAuth`, {
              method: "POST",
              body: JSON.stringify({ headers: t }),
            });
          }
          this.showAuth && ((this.showAuth = !1), (this.reauthWait = null)),
            this.refresh();
        })();
      }
      waitForLoad() {
        this.setLoading(),
          (this._loadPoll = window.setInterval(() => {
            const e = this.renderRoot.querySelector("iframe");
            (e &&
              e.contentDocument &&
              e.contentWindow &&
              ("complete" !== e.contentDocument.readyState ||
                e.contentWindow._WBWombat)) ||
              this.clearLoading(e && e.contentWindow);
          }, 5e3));
      }
      clearLoading(e) {
        this.dispatchEvent(
          new CustomEvent("replay-loading", { detail: { loading: !1 } })
        ),
          this._loadPoll &&
            (window.clearInterval(this._loadPoll), (this._loadPoll = null)),
          e &&
      ...
      setLoading() {
        this.dispatchEvent(
          new CustomEvent("replay-loading", { detail: { loading: !0 } })
        );
      }
      refresh() {
        const e = this.renderRoot.querySelector("iframe");
        if (!e) return;
        const t = this.iframeUrl;
        this.doSetIframeUrl(),
          (t !== this.iframeUrl && this.url !== this.replayUrl) ||
            (this.waitForLoad(), e.contentWindow.location.reload());
      }
      static get styles() {
        return ue(o`
      :host {
    ...
    `);
      ...
      render() {
        const e = `Replay of ${this.title ? `${this.title}:` : ""} ${this.url}`;
        return P`
    ...
    ${
      ...
      <div class="iframe-container">
        <iframe class="iframe-main" name="___wb_replay_top_frame" @message="${
          this.onReplayMessage
        }" allow="autoplay 'self'; fullscreen" allowfullscreen
    ...
    customElements.define("wr-coll-replay", Qi);
    var Ji = __webpack_require__(8690),
      Yi = __webpack_require__.n(Ji),
      Xi = __webpack_require__(5761),
      ea = __webpack_require__.n(Xi);
    class ta extends X {
      constructor() {
        super(),
          (this.sortedData = []),
      ...
      firstUpdated() {
        if (this.id) {
          const e = localStorage.getItem(`${this.id}:sortKey`);
          null !== e && (this.sortKey = e);
          const t = localStorage.getItem(`${this.id}:sortDesc`);
          null !== t && (this.sortDesc = "1" === t);
        }
      }
      updated(e) {
        const t = e.has("sortKey"),
          i = e.has("sortDesc"),
          a = e.has("data");
        t &&
          null !== this.sortKey &&
      ...
      sortData() {
        (this.sortedData = [...this.data]),
          ...
          "" === this.sortKey
            ? this.sortDesc && this.sortedData.reverse()
            : this.sortedData.sort((e, t) =>
                e[this.sortKey] === t[this.sortKey]
                  ? 0
                  : this.sortDesc == e[this.sortKey] < t[this.sortKey]
                  ? 1
                  : -1
              ),
      ...
      sendSortChanged() {
        ...
        this.dispatchEvent(new CustomEvent("sort-changed", { detail: e }));
      }
      getMore(e = 100) {
        (this.pageResults && this.numResults >= this.sortedData.length) ||
          ((this.numResults += e), this.sendSortChanged());
      }
      static get styles() {
        return ue(o`
      :host {
    ...
    customElements.define("wr-sorter", ta);
    class ia extends X {
      static get filters() {
        return [
      ...
      firstUpdated() {
        "" === this.urlSearchType && (this.urlSearchType = "prefix");
      }
      _timedUpdate() {
        null !== this.newQuery &&
          ((this.query = this.newQuery), (this.newQuery = null));
      }
      updated(e) {
        if (e.has("query") || e.has("urlSearchType") || e.has("currMime")) {
          ...
          const t = {
            ...
            i = !e.has("currMime") && !e.has("urlSearchType");
          this.dispatchEvent(
            new CustomEvent("coll-tab-nav", {
              detail: { replaceLoc: i, data: t },
            })
          );
        }
        (e.has("sortKey") || e.has("sortDesc")) && this.filter();
      }
      async doLoadResources(e = !1) {
        if (e && (!this.tryMore || !this.results.length)) return;
        if (this.loading) return;
        this.loading = !0;
        let t = "contains" !== this.urlSearchType ? this.query : "";
        const i = t && "prefix" === this.urlSearchType ? 1 : 0;
        t && !t.startsWith("http") && (t = "https://" + t);
        const a = this.currMime,
          r = new URLSearchParams({ mime: a, url: t, prefix: i, count: 100 });
        if (e) {
          const e = this.results[this.results.length - 1];
          r.set("fromMime", e.mime),
            r.set("fromUrl", e.url),
            r.set("fromStatus", e.status),
            r.set("fromTs", new Date(e.date).getTime());
        }
        let o = await fetch(`${this.collInfo.apiPrefix}/urls?${r.toString()}`);
        (o = await o.json()),
          (this.results = e ? this.results.concat(o.urls) : o.urls),
          (this.tryMore = o.urls.length >= 100),
          this.filter(),
          (this.loading = !1);
      }
      onChangeTypeSearch(e) {
        this.currMime = e.currentTarget.value;
      }
      onChangeQuery(e) {
        (this.newQuery = e.currentTarget.value),
          this._ival && window.clearTimeout(this._ival),
      ...
      onClickUrlType(e) {
        this.urlSearchType = e.currentTarget.value;
      }
      filter() {
        const e = [],
          t = "contains" === this.urlSearchType ? this.query : "";
        for (const i of this.results)
          (!t || i.url.indexOf(t) >= 0) && e.push(i);
        this.filteredResults = e;
      }
      onScroll(e) {
        const t = e.currentTarget,
          i = t.scrollHeight - t.scrollTop - t.clientHeight;
        this.tryMore && i < 40 && this.doLoadResources(!0);
      }
      static get styles() {
        return ue(o`
    :host {
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      <thead>
        <tr class="columns results-head has-text-weight-bold">
          <th scope="col" class="column col-url is-6 is-hidden-mobile"><a role="button" href="#" @click="${
            this.onSort
          }" @keyup="${ge}" data-key="url" class="${
          "url" === this.sortKey ? (this.sortDesc ? "desc" : "asc") : ""
        }">URL</a></th>
          <th scope="col" class="column col-ts is-2 is-hidden-mobile"><a role="button" href="#" @click="${
            this.onSort
          }" @keyup="${ge}" data-key="ts" class="${
          "ts" === this.sortKey ? (this.sortDesc ? "desc" : "asc") : ""
        }">Date</a></th>
          <th scope="col" class="column col-mime is-3 is-hidden-mobile"><a role="button" href="#" @click="${
            this.onSort
          }" @keyup="${ge}" data-key="mime" class="${
          "mime" === this.sortKey ? (this.sortDesc ? "desc" : "asc") : ""
        }">Mime Type</a></th>
          <th scope="col" class="column col-status is-1 is-hidden-mobile"><a role="button" href="#" @click="${
            this.onSort
          }" @keyup="${ge}" data-key="status" class="${
          "status" === this.sortKey ? (this.sortDesc ? "desc" : "asc") : ""
        }">Status</a></th>
        </tr>
      </thead>
      ...
      ${
        this.sortedResults.length
          ...
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${
              this.onReplay
            }" data-url="${e.url}" data-ts="${e.ts}" href="${Qe(
                "resources",
                e.url,
                e.ts
              )}">
            ...
            <td class="column col-ts is-2"><p class="minihead is-hidden-tablet">Date</p>${new Date(
              e.date
            ).toLocaleString()}</td>
            <td class="column col-mime is-3"><p class="minihead is-hidden-tablet">Mime Type</p>${
              e.mime
            }</td>
            <td class="column col-status is-1"><p class="minihead is-hidden-tablet">Status</p>${
              e.status
            }</td>
          </tr>
        `
      ...
      onSortChanged(e) {
        (this.sortedResults = e.detail.sortedData),
          (this.sortKey = e.detail.sortKey),
          (this.sortDesc = e.detail.sortDesc);
      }
      onReplay(e) {
        ...
        return (
          this.dispatchEvent(
            new CustomEvent("coll-tab-nav", { detail: { data: t } })
          ),
          !1
        );
      }
    }
    customElements.define("wr-coll-resources", ia);
    var aa = document.currentScript && document.currentScript.src,
      ra = "";
    class oa extends X {
      constructor() {
        super(),
      ...
      async doRegister() {
        const e = new URL(this.replaybase, window.location.href);
        if (
          ((this.isCrossOrigin = e.origin !== window.location.origin),
          this.isCrossOrigin)
        )
          return void (this.inited = !0);
        const t = this.swName,
          i = this.appName,
          a = this.replaybase,
          r = this.requireSubdomainIframe;
        this.swmanager = new Ee({
          name: t,
          scope: a,
          requireSubdomainIframe: r,
          appName: i,
        });
        try {
          await this.swmanager.register(), (this.inited = !0);
        } catch (e) {
      ...
      handleMessage(e) {
        const t = this.renderRoot.querySelector("iframe");
        if (t && e.source === t.contentWindow) {
          if (!e.data.view) return;
          if ((e.data.title && (this.title = e.data.title), !this.deepLink))
            return;
          const t = new URLSearchParams(e.data),
            i = new URL(window.location.href);
          (i.hash = "#" + t.toString()), window.history.replaceState({}, "", i);
        }
      }
      firstUpdated() {
        this.noSandbox &&
      ...
      loadBrowserDefaults() {
        void 0 !== window.GestureEvent &&
          void 0 === window.SharedWorker &&
          (this.noWebWorker = !0),
      ...
      updateFromHash() {
        ...
        e.has("url") && (this.url = e.get("url")),
          e.has("ts") && (this.ts = e.get("ts")),
          e.has("query") && (this.query = e.get("query")),
          e.has("view") && (this.view = e.get("view"));
      }
      mergeConfigs() {
        if (!this.customConfig) return this.config;
        if (this.config) {
          const e = { ...this.customConfig, ...JSON.parse(this.config) };
      ...
      updated(e) {
        if (
          ...
          const e = new URL(this.source, document.baseURI),
            t = this.mergeConfigs(),
            i = {
              source: e,
          ...
          this.deepLink ||
            ...
            (i.baseUrlSourcePrefix = "https://replayweb.page/"),
            this.noWebWorker && (i.noWebWorker = "1"),
            this.noCache && (i.noCache = "1"),
            this.hideOffscreen && (i.hideOffscreen = "1"),
            "eager" === this.loading && (i.loading = "eager"),
            (this.paramString = new URLSearchParams(i).toString()),
    ...
    ${
      this.paramString && this.hashString && this.inited
        ? P`
      <iframe sandbox="${((e) => (null != e ? e : R))(
        this.sandbox
          ? "allow-downloads allow-modals allow-orientation-lock allow-pointer-lock         allow-popups allow-popups-to-escape-sandbox allow-presentation allow-scripts         allow-same-origin allow-forms"
          : void 0
      )}"

      @load="${this.onLoad}" src="${this.replaybase}${this.replayfile}?${
            this.paramString
          }#${this.hashString}" allow="autoplay *; fullscreen"
    ...
    `;
      ...
      onLoad(e) {
        if (this.isCrossOrigin) return;
        const t = e.target.contentWindow,
          i = e.target.contentDocument;
        if (
          ...
          return (
            this.reloadCount++, void setTimeout(() => t.location.reload(), 100)
          );
        if (
          ((this.reloadCount = 0), t.customElements.get(this.mainElementName))
        )
          return;
        const a = i.createElement("script");
        (a.src = aa), i.head.appendChild(a);
      }
    }
    !(async function () {
      customElements.define("replay-web-page", oa);
    })();
  })();
